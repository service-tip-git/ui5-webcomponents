...
`,e.exports.jsx(s.h2,{id:"configuration-settings",children:"Configuration Settings"}),`
...
`,e.exports.jsx(s.h3,{id:"theme",children:"theme"}),`
...
`})}),`
`,e.exports.jsxs(s.p,{children:["For more about assets, see the dedicated ",e.exports.jsx(s.a,{href:"./?path=/docs/docs-getting-started-using-assets--docs",children:"Assets"})," section."]}),`
`,e.exports.jsxs(s.ul,{children:[`
...
`})}),`
`,e.exports.jsxs(s.ul,{children:[`
`,e.exports.jsx(s.li,{children:"To reset the theme to the default one:"}),`
`]}),`
`,e.exports.jsx(s.pre,{children:e.exports.jsx(s.code,{className:"language-js",children:`import { setTheme, getDefaultTheme } from "@ui5/webcomponents-base/dist/config/Theme.js";
setTheme(getDefaultTheme());
`})}),`
`,e.exports.jsx(s.h3,{id:"language",children:"language"}),`
...
`})}),`
`,e.exports.jsxs(s.ul,{children:[`
`,e.exports.jsx(s.li,{children:"To reset the langauge to the default one:"}),`
`]}),`
`,e.exports.jsx(s.pre,{children:e.exports.jsx(s.code,{className:"language-js",children:`import { setLanguage, getDefaultLanguage } from "@ui5/webcomponents-base/dist/config/Language.js";
setLanguage(getDefaultLanguage());
`})}),`
`,e.exports.jsx(s.h3,{id:"animationmode",children:"animationMode"}),`
...
`,e.exports.jsx(s.h3,{id:"calendartype",children:"calendarType"}),`
...
`,e.exports.jsxs(s.p,{children:["Calendar types are opt-in features, see ",e.exports.jsx(s.a,{href:"./?path=/docs/docs-getting-started-using-features--docs",children:"Using Features"}),` for details.
...
`,e.exports.jsxs(s.h3,{id:"noconflict-",children:["noConflict ",e.exports.jsx("a",{name:"no_conflict"})]}),`
...
`,e.exports.jsx(s.h3,{id:"formatsettings",children:"formatSettings"}),`
...
`})}),`
`,e.exports.jsxs(s.table,{children:[e.exports.jsx(s.thead,{children:e.exports.jsxs(s.tr,{children:[e.exports.jsx(s.th,{children:"Setting"}),e.exports.jsx(s.th,{children:"Values"}),e.exports.jsx(s.th,{children:"Default Value"}),e.exports.jsx(s.th,{children:"Description"})]})}),e.exports.jsxs(s.tbody,{children:[e.exports.jsxs(s.tr,{children:[e.exports.jsx(s.td,{children:"firstDayOfWeek"}),e.exports.jsx(s.td,{children:"0 (Sunday) through 6 (Saturday)"}),e.exports.jsx(s.td,{children:e.exports.jsx(s.em,{children:"Depends on locale"})}),e.exports.jsx(s.td,{children:"When set, overrides the locale's default value"})]}),e.exports.jsxs(s.tr,{children:[e.exports.jsx(s.td,{children:"legacyDateCalendarCustomizing"}),e.exports.jsx(s.td,{children:e.exports.jsx(s.code,{children:"{dateFormat: string, islamicMonthStart: string, gregDate: string }"})}),e.exports.jsx(s.td,{children:"[]"}),e.exports.jsx(s.td,{children:"When set, adds customizing data for Islamic calendar support"})]})]})]}),`
`,e.exports.jsxs(s.p,{children:[e.exports.jsx(s.strong,{children:"Note:"})," legacyDateCalendarCustomizing takes affect only if following features are imported:"]}),`
`,e.exports.jsx(s.pre,{children:e.exports.jsx(s.code,{className:"language-js",children:`@ui5/webcomponents-base/dist/features/LegacyDateFormats.js
`})}),`
`,e.exports.jsx(s.h3,{id:"fetchdefaultlanguage",children:"fetchDefaultLanguage"}),`
...
<\/script>
`})}),`
`,e.exports.jsx(s.h2,{id:"configuration-script",children:"Configuration Script"}),`
...
<\/script>
`})}),`
`,e.exports.jsx(s.h2,{id:"configuration-module-imports",children:"Configuration Module Imports"}),`
...
`})}),`
`,e.exports.jsxs(s.p,{children:["Next: ",e.exports.jsx(s.a,{href:"./?path=/docs/docs-advanced-rtl-and-compact-mode--docs",children:"Right-To-Left (RTL) And Compact Mode"})]})]})}function m(t={}){const{wrapper:s}=Object.assign({},r(),t.components);return s?e.exports.jsx(s,Object.assign({},t,{children:e.exports.jsx(n,t)})):n(t)}export{m as default};
//# sourceMappingURL=01-configuration.f6dfa5af.js.map
