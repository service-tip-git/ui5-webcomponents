const E = "محتوى البطاقة", _ = "البطاقة", T = "مقدمة البطاقة", A = "مقدمة بطاقة تفاعلية", I = "صورة رمزية (أفاتار)", R = "{0} معروض، {1} مخفي.", O = "قم بالتنشيط للقائمة بأكملها.", L = "الأفاتارز الفردية.", N = "الأفاتارز المربوطة.", S = "اضغط على مفاتيح الأسهم للنقل.", C = "شارة", D = "{0} من {1}", P = "مسار التنقل", B = "المزيد", U = "إلغاء", t = "الرجاء الانتظار", o = "إجراء موجب", n = "إجراء سالب", s = "مؤكد", c = "من", M = "تم عرض {0} من {1}", G = "الصفحة السابقة", K = "الصفحة التالية", V = "لوحة الألوان - الألوان المحددة مسبقًا", H = "لوحة الألوان", X = "اللون", Y = "إلغاء", W = "موافق", F = "تغيير اللون", Z = "مزيد من الألوان...", r = "عنصر تحكم ألفا", e = "عنصر تحكم تدرج اللون", a = "ست عشري", i = "أحمر", d = "أخضر", l = "أزرق", w = "ألفا", f = "فتح أداة الانتقاء", p = "إدخال التاريخ", h = "إدخال التاريخ/الوقت", u = "إدخال نطاق التواريخ", J = "حذف", b = "استعراض...", g = "تحميل ملف", m = "مقدمة المجموعة", x = "مربع القائمة", j = "تحديد الخيارات", k = "اقترحات متوفرة", q = "تحديد", v = "النتيجة المتوفرة: 1", y = "{0} النتائج متوفرة", z = "لا توجد نتائج", Q = "غامض", $ = "مؤكد", EE = "بند القائمة {0} لـ {1}", _E = "محدد", TE = "غير محدد", AE = "مقدمة المجموعة", IE = "نمط التحديد المتعدد", RE = "تحديد البنود.", OE = "توجد بنود قابلة للتحديد", LE = "توجد بنود قابلة لتحديد متعدد", NE = "توجد بنود قابلة للحذف", SE = "إغلاق شريط المعلومات", CE = "ممكن إغلاقه", DE = "شريط معلومات الخطأ", PE = "شريط معلومات التحذير", BE = "شريط معلومات النجاح", UE = "شريط المعلومات", tE = "موافق", oE = "هذه القيمة محددة بالفعل.", nE = "إدخال متعدد القيمة", sE = "{0} إضافي", cE = "توسيع/طي", ME = "النطاق", GE = "المؤشر الأيمن", KE = "المؤشر الأيسر", VE = "التصنيف", HE = "مؤشر التقييم", XE = "مطلوب", YE = "رفض", WE = "مجموعة الأزرار المقسَّمة", FE = "اضغط على SPACE أو ENTER لتحديد أحد البنود", ZE = "الزر المقسَّم", rE = "مؤشر مربع التمرير", eE = "المزيد", aE = "صف المقدمة 1 من أصل {0}", iE = "{0} من {1}", dE = "صف مقدمة المجموعة", lE = "تحديد البنود", wE = "تحديد كل الصفوف", fE = "فارغ", pE = "إيجابية", hE = "سلبية", uE = "مهم", JE = "محايد", bE = "علامة تبويب بالبنود الفرعية", gE = "التالي", mE = "السابق", xE = "قائمة التدفق", jE = "المزيد", kE = "إلغاء", qE = "اضغط على مفتاح السهم لأسفل لفتح قائمة البنود الفرعية", vE = "متبق {0} من الحروف", yE = "تم تجاوز الحد بمقدار {0} من الحروف", zE = "الساعات", QE = "الدقائق", $E = "الثواني", E_ = "موافق", __ = "إلغاء", T_ = "إدخال الوقت", A_ = "طلب الساعة", I_ = "إدخال المدة", R_ = "التاريخ", O_ = "الوقت", L_ = "قابل للحذف", N_ = "لا توجد رموز مميزة", S_ = "يتضمن رمز مميز واحد", C_ = "يحتوى على {0} من الرموز المميزة", D_ = "عارض الرموز المميزة", P_ = "إزالة", B_ = "{0} من البنود", U_ = "عنصر الشجرة", t_ = "توسيع العقدة", o_ = "طي العقدة", n_ = "حالة القيمة ’خطأ‘", s_ = "حالة القيمة ’تحذير‘", c_ = "حالة القيمة ناجح", M_ = "حالة القيمة ’معلومات‘", G_ = "إدخال غير صالح", K_ = "تم إصدار تحذير", V_ = "إدخال معلوماتي", H_ = "تم التحقق من صحة الإدخال بنجاح", X_ = "التالي", Y_ = "السابق", W_ = "رقم الأسبوع", F_ = "يوم عطلة", Z_ = "اليوم", r_ = "أداة انتقاء الشهر", e_ = "أداة انتقاء السنة", a_ = "تخفيض", i_ = "زيادة", d_ = "زر التقسيم", l_ = "اضغط على Space أو Enter لبدء تشغيل الإجراء الافتراضي وAlt + Arrow Down أو F4 لبدء تشغيل إجراء السهم", w_ = "الخلف", f_ = "رفض", p_ = "مقدمة تفاعلية", h_ = "استخدام مفاتيح Shift+Arrow لتغيير الحجم", u_ = "استخدام مفاتيح الأسهم للانتقال", J_ = "استخدام مفاتيح الأسهم للانتقال، مفاتيح Shift+Arrow لتغيير الحجم", b_ = ":", g_ = "Additional Options", m_ = {
  ...
  DIALOG_HEADER_ARIA_DESCRIBEDBY_RESIZABLE: h_,
...
export {
  ...
  l as COLORPICKER_BLUE,
  d as COLORPICKER_GREEN,
  a as COLORPICKER_HEX,
  e as COLORPICKER_HUE_SLIDER,
  ...
  h_ as DIALOG_HEADER_ARIA_DESCRIBEDBY_RESIZABLE,
