import{x as b}from"./lit-element-c5a2b594.js";import{l as t}from"./if-defined-c29cffe1.js";import{o}from"./unsafe-html-0ddd83da.js";const w={type:{control:"select",options:["Text","Email","Number","Password","Tel","URL"]},valueState:{control:"select",options:["None","Positive","Critical","Negative","Information"]},tokens:{control:{type:"text"},table:{type:{summary:"Array<IToken>"}}},default:{control:{type:"text"},table:{type:{summary:"Array<IInputSuggestionItem>"}}},icon:{control:{type:"text"},table:{type:{summary:"Array<IIcon>"}}},valueStateMessage:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},openPicker:{description:"Manually opens the suggestions popover, assuming suggestions are enabled. Items must be preloaded for it to open.",table:{category:"methods"},UI5CustomData:{returnValue:{type:{text:"void"}}}},"token-delete":{description:"Fired when a token is about to be deleted.",control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"HTMLElement"},name:"token",_ui5privacy:"public",description:"deleted token."}]}},"selection-change":{description:`Fired when the user navigates to a suggestion item via the ARROW keys,
as a preview, before the final selection.`,control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"HTMLElement"},name:"item",_ui5privacy:"public",description:"The previewed suggestion item."},{type:{text:"HTMLElement"},name:"targetRef",_ui5privacy:"public",description:"The DOM ref of the suggestion item."}]}}},N={package:"@ui5/webcomponents",since:"1.0.0-rc.9",tagName:"ui5-multi-input"};var l=Object.freeze,S=Object.defineProperty,M=(e,T)=>l(S(e,"raw",{value:l(T||e.slice())})),d;const I={title:"Main/Multi Input",component:"MultiInput",argTypes:w};let r=0;const u=e=>b`
<ui5-multi-input
    id="multi-input-${++r}"
...
>
    ...
    ${o(e.icon)}
    ${o(e.tokens)}
</ui5-multi-input>`,a=u.bind({});a.args={value:"basic input"};const i=u.bind({});i.args={tokens:`
...
<\/script>`])),e(),r,r,r)];const s=u.bind({});s.args={placeholder:"Enter product",showSuggestions:!0,default:`
    ...
    <ui5-suggestion-item text="Portable DVD Player with 9 inches LCD Monitor"></ui5-suggestion-item>`,valueStateMessage:'<div slot="valueStateMessage">Token is already in the list</div>'};var g,c,m;a.parameters={...a.parameters,docs:{...(g=a.parameters)==null?void 0:g.docs,source:{originalSource:`args => html\`
<ui5-multi-input
...
</ui5-multi-input>\``,...(m=(c=a.parameters)==null?void 0:c.docs)==null?void 0:m.source}}};var p,f,v;i.parameters={...i.parameters,docs:{...(p=i.parameters)==null?void 0:p.docs,source:{originalSource:`args => html\`
<ui5-multi-input
    id="multi-input-\${++index}"
    ?disabled="\${ifDefined(args.disabled)}"
    placeholder="\${ifDefined(args.placeholder)}"
...
>
    ...
    \${unsafeHTML(args.icon)}
    \${unsafeHTML(args.tokens)}
</ui5-multi-input>\``,...(v=(f=i.parameters)==null?void 0:f.docs)==null?void 0:v.source}}};var h,$,k;n.parameters={...n.parameters,docs:{...(h=n.parameters)==null?void 0:h.docs,source:{originalSource:`args => html\`
<ui5-multi-input
    id="multi-input-\${++index}"
    ?disabled="\${ifDefined(args.disabled)}"
    placeholder="\${ifDefined(args.placeholder)}"
...
>
    ...
    \${unsafeHTML(args.icon)}
    \${unsafeHTML(args.tokens)}
</ui5-multi-input>\``,...(D=(y=s.parameters)==null?void 0:y.docs)==null?void 0:D.source}}};const L=["Basic","Tokens","TokenCreation","SuggestionsWrapping"],_=Object.freeze(Object.defineProperty({__proto__:null,Basic:a,SuggestionsWrapping:s,TokenCreation:n,Tokens:i,__namedExportsOrder:L,default:I},Symbol.toStringTag,{value:"Module"}));export{_ as C,N as c};
