import{x as S}from"./lit-element-c5a2b594.js";import{D as T}from"./docs-d97efe99.js";import{o as m}from"./unsafe-html-0ddd83da.js";import{l as i}from"./if-defined-c29cffe1.js";import{V as C}from"./ValueState-2c5e5904.js";import"./jsx-runtime-670e1be8.js";import"./index-4e9ba9b8.js";import"./_commonjsHelpers-725317a4.js";import"./Footer-a7ea689a.js";import"./index-53d09975.js";import"./iframe-35a4826c.js";import"../sb-preview/runtime.js";import"./index-11d98b33.js";import"./index-d38538b0.js";import"./index-356e4a49.js";import"./chunk-HLWAVYOI-d1983070.js";import"./client-fb0f3103.js";const L={valueState:{control:"select",options:["None","Success","Warning","Error","Information"]},filter:{control:"select",options:["StartsWithPerTerm","StartsWith","Contains","None"]},open:{control:{type:!1}},default:{control:{type:"text"},table:{type:{summary:"Array<IMultiComboBoxItem>"}}},icon:{control:{type:"text"},table:{type:{summary:"Array<IIcon>"}}},valueStateMessage:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},"selection-change":{description:`Fired when selection is changed by user interaction
in <code>SingleSelect</code> and <code>MultiSelect</code> modes.`,control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"Array<IMultiComboBoxItem>",references:[{name:"IMultiComboBoxItem",package:"@ui5/webcomponents",module:"dist/Interfaces.js"}]},name:"items",_ui5privacy:"public",description:"an array of the selected items."}]}}},N={package:"@ui5/webcomponents",since:"0.11.0"},w="ui5-multi-combobox",O={title:"Main/Multi-Combo Box",component:"MultiComboBox",parameters:{docs:{page:T({...N,component:w})}},argTypes:L},s=e=>S`
<ui5-multi-combobox
    value="${i(e.value)}"
...
>
    ...
    `};const t=s.bind({});t.args={placeholder:"Choose your state",valueState:C.Success,allowCustomValues:!0,default:`
...
>
    ...
    \${unsafeHTML(args.icon)}
    \${unsafeHTML(args.valueStateMessage)}
</ui5-multi-combobox>\``,...($=(p=a.parameters)==null?void 0:p.docs)==null?void 0:$.source}}};var x,D,y;n.parameters={...n.parameters,docs:{...(x=n.parameters)==null?void 0:x.docs,source:{originalSource:`args => html\`
<ui5-multi-combobox
    value="\${ifDefined(args.value)}"
    ?no-typeahead="\${ifDefined(args.noTypeahead)}"
    placeholder="\${ifDefined(args.placeholder)}"
