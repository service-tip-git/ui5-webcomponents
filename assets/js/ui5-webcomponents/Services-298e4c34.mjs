import { r as l } from "./bundle.esm-587a83d6.mjs";
const t = `<svg width="160" height="160" viewBox="0 0 160 160" id="tnt-Dialog-Services-alternate">
...
`, e = `<svg width="320" height="241" viewBox="0 0 320 241" id="tnt-Scene-Services-alternate">
    <path style="fill:var(--sapContent_Illustrative_Color7)" d="M130.352 144.682H33.943a28.504 28.504 0 0 0 0 57.005h96.449a28.505 28.505 0 0 0 28.503-28.502 28.505 28.505 0 0 0-28.503-28.503h-.04Z" />
    <path style="fill:var(--sapContent_Illustrative_Color7)" d="M165.474 172.975h-96.46a28.504 28.504 0 0 0-19.808 48.462 28.504 28.504 0 0 0 19.809 8.533h96.459a28.504 28.504 0 0 0 0-56.995Zm125.49-78.818h-96.449a28.504 28.504 0 0 0-20.498 48.839 28.492 28.492 0 0 0 20.498 8.155h96.449a28.492 28.492 0 0 0 26.815-17.466 28.504 28.504 0 0 0-26.815-39.528Z" />
    <path style="fill:var(--sapContent_Illustrative_Color7)" d="M219.084 42.123H37.767A37.767 37.767 0 0 0 0 79.892a37.768 37.768 0 0 0 37.767 37.766h181.317a37.766 37.766 0 0 0 37.767-37.766 37.766 37.766 0 0 0-37.767-37.768Z" />
    <path style="fill:var(--sapContent_Illustrative_Color4)" fill-rule="evenodd" d="M154.36 47.484a3 3 0 0 1 4.155.856l81.344 123.563a3 3 0 0 1-5.011 3.3L153.504 51.64a3 3 0 0 1 .856-4.156Z" clip-rule="evenodd"/>
    <rect width="82.566" height="30.529" x="104.415" y="50.701" style="fill:var(--sapContent_Illustrative_Color2)" rx="2" transform="rotate(-33.358 104.415 50.701)"/>
    <rect width="82.566" height="30.529" x="123.974" y="80.412" style="fill:var(--sapContent_Illustrative_Color2)" rx="2" transform="rotate(-33.358 123.974 80.412)"/>
    <rect width="82.566" height="30.529" x="179.209" y="164.315" style="fill:var(--sapContent_Illustrative_Color2)" rx="2" transform="rotate(-33.358 179.209 164.315)"/>
    <rect width="82.566" height="30.529" x="198.769" y="194.027" style="fill:var(--sapContent_Illustrative_Color2)" rx="2" transform="rotate(-33.358 198.769 194.027)"/>
    <path style="fill:var(--sapContent_Illustrative_Color5)" d="m131.393 141.235 14.162-9.323 11.65 17.698-14.16 9.323z" class="sapContent_Illustrative_Color5"/>
    <path style="fill:var(--sapContent_Illustrative_Color8)" d="M136.75 123.031a5.001 5.001 0 0 1 1.427-6.926l81.933-53.938a5 5 0 0 1 6.925 1.427l25.133 38.178a5 5 0 0 1-1.427 6.925l-81.932 53.938a5 5 0 0 1-6.926-1.427l-25.133-38.177Z" class="sapContent_Illustrative_Color8"/>
    ...
    <path style="fill:var(--sapContent_Illustrative_Color4)" fill-rule="evenodd" d="M99.437 142.115a1.5 1.5 0 0 1 .85 1.944l-16.06 41.045a1.5 1.5 0 0 1-2.794-1.093l16.06-41.046a1.5 1.5 0 0 1 1.944-.85Z" clip-rule="evenodd"/>
    <path style="fill:var(--sapContent_Illustrative_Color4)" fill-rule="evenodd" d="M129.692 188.073a1.499 1.499 0 0 0-1.449-1.549l-44.05-1.473a1.5 1.5 0 1 0-.1 2.998l44.05 1.473a1.5 1.5 0 0 0 1.549-1.449Z" clip-rule="evenodd"/>
    <path style="fill:var(--sapContent_Illustrative_Color8)" fill-rule="evenodd" d="M132.461 201.1c.95 1.443 2.931 1.795 4.211.635 13.917-12.601 15.996-35.433 4.072-53.546s-33.718-25.228-50.794-17.426c-1.572.718-2.032 2.676-1.082 4.119l43.593 66.218Z" clip-rule="evenodd"/>
    ...
    <circle cx="77.409" cy="189.883" r="6.036" style="fill:var(--sapContent_Illustrative_Color9)" transform="rotate(-33.358 77.41 189.883)"/>
...
`, a = `<svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" fill="none" viewBox="0 0 128 128" id="tnt-Spot-Services-alternate">
