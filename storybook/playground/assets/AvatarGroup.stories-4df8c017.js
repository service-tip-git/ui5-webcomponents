import{x as e}from"./lit-element-c5a2b594.js";import{l as d}from"./if-defined-c29cffe1.js";import{o}from"./unsafe-html-0ddd83da.js";const g={type:{control:"select",options:["Group","Individual"]},hiddenItems:{control:{type:!1}},colorScheme:{control:{type:!1}},default:{control:{type:"text"},table:{type:{summary:"Array<IAvatarGroupItem>"}}},overflowButton:{control:{type:"text"},table:{type:{summary:"Array<IButton>"}}},click:{description:`Fired when the component is activated either with a
click/tap or by using the Enter or Space key.`,control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"HTMLElement"},name:"targetRef",_ui5privacy:"public",description:"The DOM ref of the clicked item."},{type:{text:"boolean"},name:"overflowButtonClicked",_ui5privacy:"public",description:"indicates if the overflow button is clicked"}]}}},k={package:"@ui5/webcomponents",since:"1.0.0-rc.11",tagName:"ui5-avatar-group"};var s=Object.freeze,y=Object.defineProperty,h=(a,n)=>s(y(a,"raw",{value:s(n||a.slice())})),v;let r=0;const f=()=>(r++,e(v||(v=h(['<div class="group-',`">
        <ui5-popover
        ...
        <\/script>
    </div> `])),r,r));var l=Object.freeze,M=Object.defineProperty,_=(a,n)=>l(M(a,"raw",{value:l(n||a.slice())})),p;let i=0;const z=()=>(i++,e(p||(p=_(['<div class="individual-',`">
        <ui5-popover
...
<ui5-avatar size="XL">
  ...
  >
    ...
    </ui5-avatar-group>`};const S=A.bind({}),G=z.bind({}),P=f.bind({});var u,c,m;t.parameters={...t.parameters,docs:{...(u=t.parameters)==null?void 0:u.docs,source:{originalSource:'args => html`<ui5-avatar-group\n    .type="${ifDefined(args.type)}"\n  >\n    ${unsafeHTML(args.default)}\n    ${unsafeHTML(args.overflowButton)}\n  </ui5-avatar-group> `',...(m=(c=t.parameters)==null?void 0:c.docs)==null?void 0:m.source}}};const I=["Basic","TypesAndSizes","TypeIndividualWithPopover","TypeGroupWithPopover"],$=Object.freeze(Object.defineProperty({__proto__:null,Basic:t,TypeGroupWithPopover:P,TypeIndividualWithPopover:G,TypesAndSizes:S,__namedExportsOrder:I,default:w},Symbol.toStringTag,{value:"Module"}));export{$ as C,k as c};
