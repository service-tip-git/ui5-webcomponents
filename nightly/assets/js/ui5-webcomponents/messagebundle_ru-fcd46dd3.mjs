const E = "Содержимое карты", _ = "Карта", T = "Заголовок карты", A = "Заголовок интерактивной карты", I = "Аватар", R = "{0} отображается, {1} скрыто.", O = "Активация для полного списка.", L = "Отдельные аватары.", N = "Связанные аватары.", S = "Для перемещения используйте клавиши со стрелками.", C = "Бейдж", D = "{0} из {1}", P = "Путь навигации", B = "Больше", U = "Отменить", t = "Подождите", n = "Положительная операция", s = "Отрицательная операция", o = "Выделенная", c = "из", M = "Отображается элемент {0} из {1}", G = "Предыдущая страница", K = "Следующая страница", V = "Цветовая палитра – предопределенные цвета", H = "Цветовая палитра", X = "Цвет", Y = "Отменить", W = "ОК", F = "Изменить цвет", Z = "Больше цветов...", e = "Управляющий элемент альфа", i = "Управляющий элемент оттенка", a = "Шестнадцатеричное", d = "Красный", l = "Зеленый", r = "Синий", f = "Альфа", u = "Открыть средство выбора", h = "Ввод даты", p = "Ввод даты и времени", J = "Ввод диапазона дат", b = "Удалить", g = "Обзор...", m = "Загрузить файл", x = "Заголовок группы", j = "Поле со списком", k = "Выбрать опции", q = "Есть предлагаемые значения", v = "Выбрать", w = "Доступен 1 результат", y = "Доступно результатов: {0}", z = "Нет результатов", Q = "Незаметная", $ = "Выделенная", EE = "Позиция списка {0} из {1}", _E = "Выбранные", TE = "Не выбрано", AE = "Заголовок группы", IE = "Режим множественного выбора", RE = "Выбор позиции", OE = "Содержит позиции с возможностью выбора", LE = "Содержит позиции с возможностью множественного выбора", NE = "Содержит позиции с возможностью удаления", SE = "Информационная строка - Закрыть", CE = "Можно закрыть", DE = "Информационная строка - Ошибка", PE = "Информационная строка - Предупреждение", BE = "Информационная строка - Успешно", UE = "Информационная строка", tE = "ОК", nE = "Это значение уже выбрано.", sE = "Ввод нескольких значений", oE = "Еще {0}", cE = "Развернуть/свернуть", ME = "Диапазон", GE = "Полоса прокрутки слева", KE = "Полоса прокрутки справа", VE = "Оценка", HE = "Звезды оценки", XE = "Обязательно", YE = "Отклонить", WE = "Группа сегментированных кнопок", FE = "Для выбора элемента нажмите пробел или Enter", ZE = "Сегментированная кнопка", eE = "Ползунок", iE = "Больше", aE = "Строка заголовка 1 из {0}", dE = "{0} из {1}", lE = "Строка заголовка группы", rE = "Выбор элемента", fE = "Выбрать все строки", uE = "Пусто", hE = "Положит.", pE = "Отрицат.", JE = "Критич.", bE = "Нейтральн.", gE = "Вкладка с подчиненными элементами", mE = "Дальше", xE = "Назад", jE = "Меню переполнения", kE = "Больше", qE = "Отменить", vE = "Нажмите клавишу со стрелкой вниз, чтобы открыть меню подчиненных элементов", wE = "Осталось символов: {0}", yE = "Символов свыше лимита: {0}", zE = "Часы", QE = "Минуты", $E = "Секунды", E_ = "ОК", __ = "Отменить", T_ = "Ввод времени", A_ = "Циферблат", I_ = "Ввод продолжительности", R_ = "Дата", O_ = "Время", L_ = "Возможно удаление", N_ = "Нет маркеров", S_ = "Содержит 1 маркер", C_ = "Содержит маркеры: {0}", D_ = "Генератор маркеров", P_ = "Удалить", B_ = "{0} элем.", U_ = "Элемент дерева", t_ = "Развернуть узел", n_ = "Свернуть узел", s_ = 'Статус значения "Ошибка"', o_ = 'Статус значения "Предупреждение"', c_ = 'Статус значения "Успешно"', M_ = 'Статус значения "Информация"', G_ = "Недействительный ввод", K_ = "Выдано предупреждение", V_ = "Информативная запись", H_ = "Запись успешно валидирована", X_ = "Дальше", Y_ = "Назад", W_ = "Номер недели", F_ = "Нерабочий день", Z_ = "Сегодня", e_ = "Выбор месяца", i_ = "Выбор года", a_ = "Уменьшить", d_ = "Увеличить", l_ = "Разделенная на две части кнопка", r_ = "Нажмите пробел или Enter, чтобы запустить операцию по умолчанию, и Alt + клавишу со стрелкой вниз или F4, чтобы запустить операцию стрелки", f_ = "Назад", u_ = "Отклонить", h_ = "Интерактивный заголовок", p_ = "Для изменения размера используйте Shift+клавиши со стрелками", J_ = "Для перемещения используйте клавиши со стрелками", b_ = "Для перемещения используйте клавиши со стрелками, для изменения размера используйте Shift+клавиши со стрелками", g_ = ":", m_ = "Additional Options", x_ = {
