...
>
    ...
    <ui5-suggestion-item text="USA"></ui5-suggestion-item>`,valueStateMessage:'<div slot="valueStateMessage">Token is already in the list</div>'};n.decorators=[e=>b(d||(d=L([`
	`,`
<script>
...
>
    ...
    \${unsafeHTML(args.icon)}
    \${unsafeHTML(args.tokens)}
</ui5-multi-input>\``,...(D=(y=s.parameters)==null?void 0:y.docs)==null?void 0:D.source}}};const J=["Basic","Tokens","TokenCreation","SuggestionsWrapping"];export{i as Basic,s as SuggestionsWrapping,n as TokenCreation,a as Tokens,J as __namedExportsOrder,G as default};
