import{x as v}from"./lit-element-c5a2b594.js";import{l as t}from"./if-defined-c29cffe1.js";import{o as k}from"./unsafe-html-0ddd83da.js";import{T as w}from"./TabLayout-8f6a62b3.js";const B={tabLayout:{control:"select",options:["Inline","Standard"]},overflowMode:{control:"select",options:["End","StartAndEnd"]},headerBackgroundDesign:{control:"select",options:["Solid","Transparent","Translucent"]},contentBackgroundDesign:{control:"select",options:["Solid","Transparent","Translucent"]},allItems:{control:{type:!1}},default:{control:{type:"text"},table:{type:{summary:"Array<Tab | TabSeparator>"}}},overflowButton:{control:{type:"text"},table:{type:{summary:"Array<IButton>"}}},startOverflowButton:{control:{type:"text"},table:{type:{summary:"Array<IButton>"}}},"tab-select":{description:"Fired when a tab is selected.",control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"Tab",references:[{name:"Tab",package:"@ui5/webcomponents",module:"dist/Tab.js"}]},name:"tab",_ui5privacy:"public",description:"The selected `tab`."},{type:{text:"Integer",references:[{name:"Integer",package:"@ui5/webcomponents-base",module:"dist/types/Integer.js"}]},name:"tabIndex",_ui5privacy:"public",description:"The selected `tab` index in the flattened array of all tabs and their subTabs, provided by the `allItems` getter."}]}}},q={package:"@ui5/webcomponents",tagName:"ui5-tabcontainer"},L={title:"Main/Tab Container",component:"TabContainer",argTypes:B},s=e=>v`<ui5-tabcontainer
...
}`,...(h=(T=o.parameters)==null?void 0:T.docs)==null?void 0:h.source}}};var D,y,$;r.parameters={...r.parameters,docs:{...(D=r.parameters)==null?void 0:D.docs,source:{originalSource:`args => {
  return html\`<ui5-tabcontainer
    ?collapsed="\${ifDefined(args.collapsed)}"
    tab-layout="\${ifDefined(args.tabLayout)}"
    overflow-mode="\${ifDefined(args.overflowMode)}"
...
}`,...($=(y=r.parameters)==null?void 0:y.docs)==null?void 0:$.source}}};const S=["Basic","TextOnlyTabs","TextOnlyEndOverflow","InlineTabLayout","NestedTabs"],C=Object.freeze(Object.defineProperty({__proto__:null,Basic:a,InlineTabLayout:o,NestedTabs:r,TextOnlyEndOverflow:n,TextOnlyTabs:i,__namedExportsOrder:S,default:L},Symbol.toStringTag,{value:"Module"}));export{C,q as c};
