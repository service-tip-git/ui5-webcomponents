import{x as e}from"./lit-element-c5a2b594.js";import{l as o}from"./if-defined-c29cffe1.js";import{o as s}from"./unsafe-html-0ddd83da.js";const g={type:{control:"select",options:["Group","Individual"]},hiddenItems:{control:{type:!1}},colorScheme:{control:{type:!1}},default:{control:{type:"text"},table:{type:{summary:"Array<IAvatar>"}}},overflowButton:{control:{type:"text"},table:{type:{summary:"Array<IButton>"}}},click:{description:`Fired when the component is activated either with a
...
<ui5-avatar size="XL">
  ...
  >
    ...
    </ui5-avatar-group>`};const S=A.bind({}),P=z.bind({}),G=f.bind({});var c,m,d;t.parameters={...t.parameters,docs:{...(c=t.parameters)==null?void 0:c.docs,source:{originalSource:'args => html`<ui5-avatar-group\n    .type="${ifDefined(args.type)}"\n    .aria-haspopup="${ifDefined(args.ariaHaspopup)}"\n  >\n    ${unsafeHTML(args.default)}\n    ${unsafeHTML(args.overflowButton)}\n  </ui5-avatar-group> `',...(d=(m=t.parameters)==null?void 0:m.docs)==null?void 0:d.source}}};const I=["Basic","TypesAndSizes","TypeIndividualWithPopover","TypeGroupWithPopover"],k=Object.freeze(Object.defineProperty({__proto__:null,Basic:t,TypeGroupWithPopover:G,TypeIndividualWithPopover:P,TypesAndSizes:S,__namedExportsOrder:I,default:w},Symbol.toStringTag,{value:"Module"}));export{k as C,$ as c};
