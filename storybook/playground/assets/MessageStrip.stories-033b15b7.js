import{x as b}from"./lit-element-c5a2b594.js";import{l as s}from"./if-defined-c29cffe1.js";import{o as r}from"./unsafe-html-0ddd83da.js";import{M}from"./MessageStripDesign-20271609.js";const h={design:{control:"select",options:["Information","Positive","Negative","Warning","ColorSet1","ColorSet2"]},default:{control:{type:"text"},table:{type:{summary:"Array<Node>"}}},icon:{control:{type:"text"},table:{type:{summary:"Array<IIcon>"}}}},N={package:"@ui5/webcomponents",since:"0.9.0",tagName:"ui5-message-strip"};var o=Object.freeze,w=Object.defineProperty,$=(e,y)=>o(w(e,"raw",{value:o(y||e.slice())})),a;const x={title:"Main/Message Strip",component:"MessageStrip",argTypes:h},v=e=>b`<ui5-message-strip 
    design="${s(e.design)}"
...
<\/script>
\``,...(g=(m=i.parameters)==null?void 0:m.docs)==null?void 0:g.source}}};var l,S,f;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`args => html\`<ui5-message-strip 
    design="\${ifDefined(args.design)}"
    ?hide-icon="\${ifDefined(args.hideIcon)}"
    ?hide-close-button="\${ifDefined(args.hideCloseButton)}"
>
...
\``,...(f=(S=n.parameters)==null?void 0:S.docs)==null?void 0:f.source}}};const C=["Basic","Dynamic","Custom"],D=Object.freeze(Object.defineProperty({__proto__:null,Basic:t,Custom:n,Dynamic:i,__namedExportsOrder:C,default:x},Symbol.toStringTag,{value:"Module"}));export{D as C,N as c};
