...
`]}),`
`,e.jsxs(n.p,{children:["Try running the test page with the following URL parameters: ",e.jsx(n.code,{children:"sap-ui-theme=sap_belize_hcb&sap-ui-language=de"})]}),`
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"http://localhost:3000/?sap-ui-theme=sap_belize_hcb&sap-ui-language=de",target:"_blank",rel:"nofollow noopener noreferrer",children:"http://localhost:3000/?sap-ui-theme=sap_belize_hcb&sap-ui-language=de"})}),`
`,e.jsx(n.p,{children:"You should be able to see the page with an accessibility theme, and in German language."})]})}function g(s={}){const{wrapper:n}=Object.assign({},o(),s.components);return n?e.jsx(n,Object.assign({},s,{children:e.jsx(t,s)})):t(s)}export{g as default};
//# sourceMappingURL=08-wrapping-up-26704c13.js.map
