import{j as e}from"./jsx-runtime.97c1caca.js";import{M as r}from"./index.50a0f25a.js";import{u as o}from"./index.3107f185.js";import"./index.bdfa8201.js";import"./_commonjsHelpers.b8add541.js";import"./iframe.bd4c65dd.js";import"../sb-preview/runtime.js";import"./index.5ca63ce8.js";import"./index.5f460d07.js";import"./index.d612502e.js";import"./index.b38f6aa4.js";function s(n){const t=Object.assign({h1:"h1",p:"p",ul:"ul",li:"li",a:"a",code:"code",h2:"h2",ol:"ol",h3:"h3",pre:"pre",strong:"strong",h4:"h4",em:"em"},o(),n.components);return e.exports.jsxs(e.exports.Fragment,{children:[e.exports.jsx(r,{title:"Docs/Development/Deep dive and best practices"}),`
`,e.exports.jsx(t.h1,{id:"deep-dive-and-best-practices",children:"Deep dive and best practices"}),`
...
`,e.exports.jsx(t.li,{children:e.exports.jsx(t.a,{href:"./?path=/docs/docs-development-custom-ui5-web-components--docs",children:"Developing Custom UI5 Web Components"})}),`
`,e.exports.jsx(t.li,{children:e.exports.jsx(t.a,{href:"./?path=/docs/docs-development-understanding-components-metadata--docs",children:"Understanding UI5 Web Components Metadata"})}),`
`,e.exports.jsx(t.li,{children:e.exports.jsxs(t.a,{href:"./?path=/docs/docs-development-understanding-hbs-templates--docs",children:["Understanding the Handlebars (",e.exports.jsx(t.code,{children:".hbs"}),") templates"]})}),`
`]}),`
`,e.exports.jsx(t.p,{children:"as this article will expand on many of the notions, introduced there."}),`
`,e.exports.jsx(t.h2,{id:"table-of-contents",children:"Table of contents"}),`
...
`]}),`
`]}),`
`,e.exports.jsxs(t.h2,{id:"metadata-deep-dive-",children:["Metadata deep dive ",e.exports.jsx("a",{name:"metadata"})]}),`
...
`]}),`
`,e.exports.jsxs(t.h3,{id:"tag-",children:["Tag ",e.exports.jsx("a",{name:"metadata_tag"})]}),`
...
See `,e.exports.jsx(t.a,{href:"./?path=/docs/docs-advanced-scoping--docs",children:"Scoping"})," for more on using a suffix with tag names."]}),`
...
`})}),`
`,e.exports.jsxs(t.p,{children:["Even if a suffix for tag names is configured (as described in ",e.exports.jsx(t.a,{href:"./?path=/docs/docs-advanced-scoping--docs",children:"Scoping"}),`), the attribute with
...
`})}),`
`,e.exports.jsxs(t.h3,{id:"properties-",children:["Properties ",e.exports.jsx("a",{name:"metadata_properties"})]}),`
`,e.exports.jsx(t.h4,{id:"properties-are-managed-state",children:"Properties are managed state"}),`
...
`,e.exports.jsx(t.h4,{id:"properties-vs-attributes",children:"Properties vs attributes"}),`
...
`,e.exports.jsx(t.h4,{id:"public-vs-private-properties",children:"Public vs private properties"}),`
...
`,e.exports.jsx(t.h4,{id:"property-types-and-default-values",children:"Property types and default values"}),`
...
`,e.exports.jsxs(t.h4,{id:"properties-with-multiple-true",children:["Properties with ",e.exports.jsx(t.code,{children:"multiple: true"})]}),`
...
`,e.exports.jsx(t.h4,{id:"examples",children:"Examples"}),`
...
`,e.exports.jsx(t.h4,{id:"best-practices-for-using-properties",children:"Best practices for using properties"}),`
...
`,e.exports.jsx(t.h4,{id:"metadata-properties-vs-normal-js-properties",children:"Metadata properties vs normal JS properties"}),`
...
`,e.exports.jsxs(t.h3,{id:"slots-",children:["Slots ",e.exports.jsx("a",{name:"metadata_slots"})]}),`
...
`,e.exports.jsxs(t.p,{children:["You can read more about the ",e.exports.jsx(t.code,{children:"slot"})," HTML Element ",e.exports.jsx(t.a,{href:"https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot",target:"_blank",rel:"nofollow noopener noreferrer",children:"here"}),"."]}),`
`,e.exports.jsx(t.h4,{id:"default-slot-and-named-slots",children:"Default slot and named slots"}),`
...
`,e.exports.jsx(t.h4,{id:"slot-types",children:"Slot types"}),`
...
`,e.exports.jsx(t.h4,{id:"are-slots-managed-state",children:"Are slots managed state?"}),`
...
`,e.exports.jsx(t.h4,{id:"slot-accessors",children:"Slot accessors"}),`
...
`,e.exports.jsx(t.h4,{id:"individual-slots",children:"Individual slots"}),`
...
`,e.exports.jsxs(t.p,{children:["The ",e.exports.jsx(t.code,{children:"individualSlots"})," slot metadata configuration setting (see ",e.exports.jsx(t.a,{href:"./?path=/docs/docs-development-understanding-components-metadata--docs",children:"Understanding UI5 Web Components Metadata"}),") allows you to have a separate physical slot for each child belonging to a certain slot."]}),`
`,e.exports.jsx(t.p,{children:"Example:"}),`
...
`,e.exports.jsxs(t.p,{children:["For more information on individual slots and how to render them in the ",e.exports.jsx(t.code,{children:".hbs"})," template click ",e.exports.jsx(t.a,{href:"./?path=/docs/docs-development-understanding-hbs-templates.md#slots_individual--docs",children:"here"}),"."]}),`
`,e.exports.jsx(t.h4,{id:"the-invalidateonchildchange-setting",children:"The invalidateOnChildChange setting"}),`
...
`,e.exports.jsxs(t.h3,{id:"events-",children:["Events ",e.exports.jsx("a",{name:"metadata_events"})]}),`
...
`,e.exports.jsxs(t.p,{children:["For more on the ",e.exports.jsx(t.code,{children:".hbs"})," template syntax and event listeners click ",e.exports.jsx(t.a,{href:"./?path=/docs/docs-development-understanding-hbs-templates.md#syntax_at--docs",children:"here"}),"."]}),`
...
`})}),`
`,e.exports.jsx(t.h4,{id:"working-with-event-parameters",children:"Working with event parameters"}),`
...
`})}),`
`,e.exports.jsx(t.h4,{id:"events-and-noconflict-mode",children:"Events and noConflict mode"}),`
...
`})}),`
`,e.exports.jsxs(t.p,{children:["will dispatch two ",e.exports.jsx(t.a,{href:"https://developer.mozilla.org/en-US/docs/Web/Events/Creating_and_triggering_events",target:"_blank",rel:"nofollow noopener noreferrer",children:"custom events"})," by default:"]}),`
`,e.exports.jsxs(t.ul,{children:[`
...
`]}),`
`,e.exports.jsxs(t.p,{children:["However, if you set the ",e.exports.jsx(t.a,{href:"./?path=/docs/docs-advanced-configuration.md#no_conflict--docs",children:"noConflict"})," configuration setting to ",e.exports.jsx(t.code,{children:"true"}),", only the ",e.exports.jsx(t.strong,{children:"prefixed"})," event will be dispatched."]}),`
...
`,e.exports.jsxs(t.h3,{id:"wrapping-up-metadata-",children:["Wrapping up metadata ",e.exports.jsx("a",{name:"metadata_wrapping_up"})]}),`
...
`,e.exports.jsxs(t.h2,{id:"understanding-rendering-",children:["Understanding rendering ",e.exports.jsx("a",{name:"rendering"})]}),`
`,e.exports.jsxs(t.h3,{id:"what-is-rendering-",children:["What is rendering? ",e.exports.jsx("a",{name:"rendering_def"})]}),`
...
`,e.exports.jsxs(t.h3,{id:"physical-and-logical-components-",children:["Physical and logical components ",e.exports.jsx("a",{name:"rendering_physical_logical"})]}),`
...
`,e.exports.jsxs(t.h3,{id:"what-is-invalidation-",children:["What is invalidation? ",e.exports.jsx("a",{name:"invalidation"})]}),`
...
Finally, `,e.exports.jsx(t.code,{children:"invalidateOnChildChange"})," allows for more fine-granular rules when exactly children can invalidate their parents - see ",e.exports.jsx(t.a,{href:"./?path=/docs/docs-development-understanding-components-metadata--docs",children:"Understanding UI5 Web Components Metadata"}),"."]}),`
`,e.exports.jsxs(t.h2,{id:"lifecycle-hooks-",children:["Lifecycle hooks ",e.exports.jsx("a",{name:"lifecycle"})]}),`
...
`,e.exports.jsxs(t.h3,{id:"1-constructor-",children:["1. ",e.exports.jsx(t.code,{children:"constructor"})," ",e.exports.jsx("a",{name:"lifecycle_constructor"})]}),`
...
`})}),`
`,e.exports.jsxs(t.h3,{id:"2-onbeforerendering-",children:["2. ",e.exports.jsx(t.code,{children:"onBeforeRendering"})," ",e.exports.jsx("a",{name:"lifecycle_before"})]}),`
...
`,e.exports.jsxs(t.h3,{id:"3-onafterrendering-",children:["3. ",e.exports.jsx(t.code,{children:"onAfterRendering"})," ",e.exports.jsx("a",{name:"lifecycle_after"})]}),`
...
`})}),`
`,e.exports.jsxs(t.h3,{id:"4-onenterdom-and-onexitdom-",children:["4. ",e.exports.jsx(t.code,{children:"onEnterDOM"})," and ",e.exports.jsx(t.code,{children:"onExitDOM"})," ",e.exports.jsx("a",{name:"lifecycle_dom"})]}),`
...
`,e.exports.jsxs(t.h2,{id:"the-static-area-",children:["The static area ",e.exports.jsx("a",{name:"static"})]}),`
`,e.exports.jsxs(t.h3,{id:"preface-",children:["Preface ",e.exports.jsx("a",{name:"static_preface"})]}),`
`,e.exports.jsxs(t.p,{children:["This section expands on the UI5 Web Components class structure, so if you haven't, please check ",e.exports.jsx(t.a,{href:"./?path=/docs/docs-development-custom-ui5-web-components--docs",children:"Developing Custom UI5 Web Components"})," first."]}),`
...
`,e.exports.jsxs(t.h3,{id:"what-is-the-static-area-and-why-is-it-needed-",children:["What is the static area and why is it needed? ",e.exports.jsx("a",{name:"static_what_why"})]}),`
...
regardless of the page structure and `,e.exports.jsx(t.a,{href:"https://developer.mozilla.org/en-US/docs/Glossary/Stacking_context",target:"_blank",rel:"nofollow noopener noreferrer",children:"stacking context"}),"."]}),`
...
`,e.exports.jsxs(t.h3,{id:"using-the-static-area-",children:["Using the static area ",e.exports.jsx("a",{name:"static_using"})]}),`
...
`,e.exports.jsxs(t.h3,{id:"accessing-the-static-area-item-",children:["Accessing the static area item ",e.exports.jsx("a",{name:"static_accessing"})]}),`
...
`,e.exports.jsxs(t.p,{children:["Also, note that no matter how many times you call ",e.exports.jsx(t.code,{children:"getStaticAreaItemDomRef"}),", the static area item will be created only the first time."]}),`
`,e.exports.jsxs(t.p,{children:["Next: ",e.exports.jsx(t.a,{href:"./?path=/docs/docs-development-typescript-in-ui5-web-components--docs",children:"Typescript In UI5 Web Components"})]})]})}function g(n={}){const{wrapper:t}=Object.assign({},o(),n.components);return t?e.exports.jsx(t,Object.assign({},n,{children:e.exports.jsx(s,n)})):s(n)}export{g as default};
//# sourceMappingURL=06-deep-dive-and-best-practices.51e067b1.js.map
