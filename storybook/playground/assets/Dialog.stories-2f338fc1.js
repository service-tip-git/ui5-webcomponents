...
<\/script>`])),i(e.headerText),i(e.stretch),i(e.draggable),i(e.resizable),i(e.state),i(e.initialFocus),i(e.preventFocusRestore),i(e.open),i(e.accessibleName),i(e.accessibleNameRef),i(e.accessibleRole),l(e.header),l(e.default),l(e.footer)),a=r.bind({});a.args={headerText:"Register Form",default:`<section class="login-form">
    <div>
...
${e()}`];const o=r.bind({});o.args={resizable:!0,draggable:!0,headerText:"Draggable/Resizable dialog",default:`<p>Move this dialog around the screen by dragging it by its header.</p>
...
${e()}`];const t=r.bind({});t.args={state:E.Negative,default:"<p>Dialog with state</p>",footer:`<div slot="footer" style="display: flex; justify-content: flex-end; width: 100%; align-items: center">
    <ui5-button class="dialogCloser">Close</ui5-button>
</div>`};t.decorators=[(e,{args:s})=>e({args:{...s,headerText:s.state}})];var u,p,f;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`args => {
  return html\`
<ui5-button id="dialogOpener">Open Dialog</ui5-button>
...
<\/script>\`;
}`,...(D=(y=n.parameters)==null?void 0:y.docs)==null?void 0:D.source}}};var $,x,O;t.parameters={...t.parameters,docs:{...($=t.parameters)==null?void 0:$.docs,source:{originalSource:`args => {
  return html\`
<ui5-button id="dialogOpener">Open Dialog</ui5-button>
...
<\/script>\`;
}`,...(O=(x=t.parameters)==null?void 0:x.docs)==null?void 0:O.source}}};const R=["Basic","DraggableAndResizable","BarInDialog","WithState"],M=Object.freeze(Object.defineProperty({__proto__:null,BarInDialog:n,Basic:a,DraggableAndResizable:o,WithState:t,__namedExportsOrder:R,default:L},Symbol.toStringTag,{value:"Module"}));export{M as C,A as c};
