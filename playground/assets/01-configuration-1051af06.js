import{j as e}from"./jsx-runtime-5fc188ad.js";import{M as c}from"./index-9c2f7062.js";import{u as t}from"./index-cf712c1b.js";import"./index-c0290abd.js";import"./_commonjsHelpers-725317a4.js";import"./iframe-17871902.js";import"../sb-preview/runtime.js";import"./index-d475d2ea.js";import"./index-d37d4223.js";import"./index-d38538b0.js";import"./index-356e4a49.js";function i(s){const n=Object.assign({h1:"h1",p:"p",em:"em",h2:"h2",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td",a:"a",code:"code",h3:"h3",ul:"ul",li:"li",pre:"pre",strong:"strong"},t(),s.components);return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"Docs/Advanced/Configuration"}),`
...
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"sap_horizon"})," is known as ",e.jsx(n.code,{children:"Morning Horizon"})," and it's the latest theme currently available as a preview version."]}),`
...
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"sap_fiori_3"})," is known as ",e.jsx(n.code,{children:"Quartz Light"})," and it`s the default theme."]}),`
...
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"sap_belize"})," is known as ",e.jsx(n.code,{children:"Belize"}),"."]}),`
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"sap_belize_hcb"})," is known as ",e.jsx(n.code,{children:"High Contrast Black"}),"."]}),`
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"sap_belize_hcw"})," is known as ",e.jsx(n.code,{children:"High Contrast White"}),"."]}),`
`]}),`
`,e.jsxs(n.p,{children:["The default theme (",e.jsx(n.code,{children:"sap_fiori_3"}),`) is built in all UI5 Web Components. Thus, components are always themed.
Configuring another theme will additionally fetch and use that theme. Any theme is fetched just once.`]}),`
`,e.jsxs(n.p,{children:["To use additional themes (other than ",e.jsx(n.code,{children:"sap_fiori_3"}),"):"]}),`
`,e.jsxs(n.ul,{children:[`
...
`})}),`
`,e.jsxs(n.p,{children:["Next: ",e.jsx(n.a,{href:"./?path=/docs/docs-advanced-rtl-and-compact-mode--docs",children:"Right-To-Left (RTL) And Compact Mode"})]})]})}function m(s={}){const{wrapper:n}=Object.assign({},t(),s.components);return n?e.jsx(n,Object.assign({},s,{children:e.jsx(i,s)})):i(s)}export{m as default};
//# sourceMappingURL=01-configuration-1051af06.js.map
