      ...
      <Wizard onStepChange={handleStepChange}>
        ...
        <WizardStep icon="hint" titleText="Product Information" disabled={step2Disabled} selected={step2Selected}>
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              <div style={{ display: "flex", flexDirection: "row", justifyContent: "flex-end", alignItems: "center", marginTop: "1rem" }}>
                <Label>Name</Label>
                <Input placeholder="product name..." />
              </div>
              <div style={{ display: "flex", flexDirection: "row", marginTop: "1rem", justifyContent: "flex-end", alignItems: "center" }}>
                <Label>Weight</Label>
                <Input value="3.65" />
              </div>
              <div style={{ display: "flex", flexDirection: "row", marginTop: "1rem", justifyContent: "flex-end", alignItems: "center" }}>
        ...
        <WizardStep icon="action-settings" titleText="Options" disabled={step3Disabled} selected={step3Selected}>
          ...
          {!finalizeHidden && <Button design="Emphasized" onClick={handleFinalizeClick}>Finalize</Button>}
        </WizardStep>
      </Wizard>
    </>
  );
