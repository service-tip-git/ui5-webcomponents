const E = "卡内容", _ = "卡", T = "卡抬头", A = "交互式卡抬头", I = "头像", R = "{0} 个显示，{1} 个隐藏。", O = "为整个列表激活。", L = "单独头像。", N = "联合头像。", S = "按箭头键进行移动。", C = "徽章", D = "{0} / {1}", P = "位置指示节点跟踪", B = "更多", U = "取消", t = "请稍候", n = "积极操作", s = "消极操作", o = "加重", c = "/", M = "显示项目 {0}，共 {1} 个", G = "上一页", K = "下一页", V = "调色板 - 预定义颜色", H = "调色板", X = "颜色", Y = "取消", W = "确定", F = "更改颜色", Z = "更多颜色...", a = "Alpha 控制", e = "色度控制", l = "十六进制", h = "红色", i = "绿色", d = "蓝色", p = "Alpha", f = "打开选取器", r = "日期输入", u = "日期时间输入", J = "日期范围输入", b = "删除", g = "浏览...", m = "上载文件", x = "组抬头", z = "列表框", j = "选择选项", k = "有可用建议", q = "选择", v = "1 个结果可用", w = "{0} 个结果可用", y = "无结果", Q = "隐蔽", $ = "加重", EE = "列表项目 {0}/{1}", _E = "已选择", TE = "未选择", AE = "组抬头", IE = "多重选择模式", RE = "项目选择。", OE = "包含可选择的项目", LE = "包含可多重选择的项目", NE = "包含可删除的项目", SE = "信息栏关闭", CE = "可关闭", DE = "错误信息栏", PE = "警告信息栏", BE = "成功信息栏", UE = "信息栏", tE = "确定", nE = "已选择此值。", sE = "多值输入", oE = "其他 {0} 个", cE = "展开/折叠", ME = "范围", GE = "左手柄", KE = "右手柄", VE = "评级", HE = "评级指示器", XE = "必需", YE = "拒绝", WE = "分段式按钮组", FE = "按空格键或 ENTER 选择项目", ZE = "分段式按钮", aE = "滑块手柄", eE = "更多", lE = "抬头行 1 / {0}", hE = "{0} / {1}", iE = "组抬头行", dE = "项目选择", pE = "选择所有行", fE = "空", rE = "积极", uE = "消极", JE = "临界", bE = "中性", gE = "含有子项目的标签", mE = "下一个", xE = "上一个", zE = "溢出菜单", jE = "更多", kE = "取消", qE = "按下箭头键打开子项目菜单", vE = "剩余 {0} 个字符", wE = "超过限制 {0} 个字符", yE = "小时", QE = "分钟", $E = "秒", E_ = "确定", __ = "取消", T_ = "时间输入", A_ = "钟表盘", I_ = "持续时间输入", R_ = "日期", O_ = "时间", L_ = "可删除", N_ = "无令牌", S_ = "包含 1 个令牌", C_ = "包含 {0} 个令牌", D_ = "分词器", P_ = "移除", B_ = "{0} 个项目", U_ = "树项目", t_ = "展开节点", n_ = "折叠节点", s_ = "值状态错误", o_ = "值状态警告", c_ = "值状态成功", M_ = "值状态信息", G_ = "无效输入", K_ = "已发出警告", V_ = "信息输入", H_ = "已成功验证输入", X_ = "下一个", Y_ = "上一个", W_ = "周号", F_ = "非工作日", Z_ = "今天", a_ = "月份选取器", e_ = "年度选取器", l_ = "减少", h_ = "增加", i_ = "拆分按钮", d_ = "按空格键或 Enter 触发缺省操作，按 Alt + 向下箭头或 F4 触发箭头操作", p_ = "返回", f_ = "拒绝", r_ = "交互式抬头", u_ = "使用 Shift+箭头键重新调整大小", J_ = "使用箭头键进行移动", b_ = "使用箭头键进行移动，使用 Shift+箭头键重新调整大小", g_ = "：", m_ = "Additional Options", x_ = {
  ...
  DAY_PICKER_TODAY: Z_,
  MONTH_PICKER_DESCRIPTION: a_,
  YEAR_PICKER_DESCRIPTION: e_,
  STEPINPUT_DEC_ICON_TITLE: l_,
  STEPINPUT_INC_ICON_TITLE: h_,
  SPLIT_BUTTON_DESCRIPTION: i_,
...
export {
  ...
  a_ as MONTH_PICKER_DESCRIPTION,
  ...
  i_ as SPLIT_BUTTON_DESCRIPTION,
  d_ as SPLIT_BUTTON_KEYBOARD_HINT,
  l_ as STEPINPUT_DEC_ICON_TITLE,
