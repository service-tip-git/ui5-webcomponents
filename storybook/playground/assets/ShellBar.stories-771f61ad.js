...
>
    ...
    <ui5-avatar slot="profile">
        <img src="../assets/images/avatars/woman_avatar_5.png" />
    </ui5-avatar>`,logo:'<img slot="logo" src="../assets/images/sap-logo-svg.svg" />'};let s=0;const r=()=>(s++,D(u||(u=L([`
        <ui5-shellbar
            id="shellbar-`,`"
  ...
  return html\`
        ...
        <\/script>
    \`;
}`,...(T=(w=r.parameters)==null?void 0:w.docs)==null?void 0:T.source}}};const _=["Basic","Search","WithJoule","Advanced"],F=Object.freeze(Object.defineProperty({__proto__:null,Advanced:r,Basic:o,Search:n,WithJoule:a,__namedExportsOrder:_,default:M},Symbol.toStringTag,{value:"Module"}));export{F as C,x as c};
