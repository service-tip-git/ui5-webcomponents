const E = "카드 컨텐트", _ = "카드", T = "카드 헤더", A = "대화형 카드 헤더", I = "아바타", R = "{0} 표시됨, {1} 숨김", O = "전체 리스트에서 활성화", L = "개별 아바타", N = "결합된 아바타", S = "이동하려면 화살표 키를 누르십시오.", C = "배지", D = "{0}/{1}", P = "탐색 경로 추적", B = "기타", U = "취소", t = "잠시 기다려 주십시오.", o = "긍정적 액션", n = "부정적 액션", s = "강조", c = "/", M = "항목 {0}/{1} 표시됨", G = "이전 페이지", K = "다음 페이지", V = "색상표 - 사전 정의된 색", H = "색상표", X = "색", Y = "취소", W = "확인", F = "색 변경", Z = "다른 색...", e = "알파 제어", i = "색상 제어", a = "16진수", d = "빨강", l = "녹색", r = "파랑", f = "알파", h = "선택 도구 열기", p = "일자 입력", u = "일자/시간 입력", w = "일자 범위 입력", J = "삭제", b = "찾아보기...", g = "파일 업로드", k = "그룹 헤더", m = "리스트 상자", x = "옵션 선택", j = "제안 사용 가능", q = "선택", v = "한 개의 결과 사용 가능", y = "{0}개 결과를 사용할 수 있습니다.", z = "결과 없음", Q = "미약", $ = "강조", EE = "{1}의 리스트 항목 {0}", _E = "선택됨", TE = "선택되지 않음", AE = "그룹 헤더", IE = "복수 선택 모드", RE = "항목 선택", OE = "선택 가능 항목 포함", LE = "복수 선택 가능 항목 포함", NE = "삭제 가능 항목 포함", SE = "정보 바 닫기", CE = "닫기 가능", DE = "오류 정보 바", PE = "경고 정보 바", BE = "성공 정보 바", UE = "정보 바", tE = "확인", oE = "이 값은 이미 선택되어 있습니다.", nE = "다중 값 입력", sE = "{0}개 항목 더 보기", cE = "펼치기/접기", ME = "범위", GE = "왼쪽 핸들", KE = "오른쪽 핸들", VE = "평가", HE = "평가 지시자", XE = "필요", YE = "거부", WE = "세그멘테이션된 버튼 그룹", FE = "항목을 선택하려면 SPACE 또는 ENTER를 누르십시오.", ZE = "세그멘테이션된 버튼", eE = "슬라이더 핸들", iE = "추가", aE = "{0}의 헤더 행 1", dE = "{0}/{1}", lE = "그룹 헤더 행", rE = "항목 선택", fE = "모든 행 선택", hE = "비어 있음", pE = "포지티브", uE = "네거티브", wE = "중요", JE = "중립", bE = "하위 항목이 있는 탭", gE = "다음", kE = "이전", mE = "오버플로우 메뉴", xE = "자세히", jE = "취소", qE = "아래쪽 화살표 키를 눌러 하위 항목 메뉴 열기", vE = "{0}자 남아 있음", yE = "{0}자 초과", zE = "시간", QE = "분", $E = "초", E_ = "OK", __ = "취소", T_ = "시간 입력", A_ = "시계 다이얼", I_ = "기간 입력", R_ = "일자", O_ = "시간", L_ = "삭제 가능", N_ = "토큰 없음", S_ = "한 개의 토큰 포함", C_ = "{0}개의 토큰 포함", D_ = "토크나이저", P_ = "제거", B_ = "{0}개 항목", U_ = "트리 항목", t_ = "노드 펼치기", o_ = "노드 접기", n_ = "값 상태 오류", s_ = "값 상태 경고", c_ = "값 상태 성공", M_ = "값 상태 정보", G_ = "엔트리가 유효하지 않습니다.", K_ = "경고 발생", V_ = "정보 엔트리", H_ = "유효한 엔트리입니다.", X_ = "다음", Y_ = "이전", W_ = "주수", F_ = "휴무일", Z_ = "오늘", e_ = "월 선택 도구", i_ = "연도 선택 도구", a_ = "감소", d_ = "증가", l_ = "분할 버튼", r_ = "스페이스바 또는 Enter를 눌러 기본 액션 및 Alt + Arrow Down 또는 F4를 트리거하거나 화살표 액션을 트리거합니다.", f_ = "뒤로", h_ = "거부", p_ = "대화형 헤더", u_ = "크기를 조정하려면 Shift+화살표 키를 사용하십시오.", w_ = "이동하려면 화살표 키를 사용하십시오.", J_ = "이동하려면 화살표 키를 사용하고 크기를 조정하려면 Shift+화살표 키를 사용하십시오.", b_ = ":", g_ = "Additional Options", k_ = {
