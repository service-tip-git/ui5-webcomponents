const E = "卡片內容", _ = "卡片", T = "卡片表頭", A = "互動式卡片表頭", I = "虛擬個人頭像", R = "已顯示 {0}、已隱藏 {1}。", O = "針對完整清單而啟用。", L = "個別虛擬個人頭像。", N = "結合虛擬個人頭像。", S = "按箭頭鍵以移動。", C = "徽章", D = "{0}/{1}", P = "路徑指引追蹤", B = "更多", U = "取消", t = "請稍候", n = "正向作業", s = "負向作業", o = "強調", c = "/", M = "已顯示項目 {0}/{1}", G = "上一頁", K = "下一頁", V = "調色盤 - 預先定義的色彩", H = "調色盤", X = "色彩", Y = "取消", W = "確定", F = "更改色彩", Z = "更多色彩...", a = "Alpha 控制", e = "色調控制", l = "十六進位", h = "紅色", i = "綠色", d = "藍色", p = "Alpha", f = "開啟選擇器", r = "日期輸入", u = "日期時間輸入", J = "日期範圍輸入", b = "刪除", g = "瀏覽...", m = "上傳檔案", x = "群組表頭", z = "清單方塊", j = "選擇選項", k = "可用建議", q = "選擇", v = "1 個可用的結果", w = "{0} 個可用的結果", y = "沒有結果", Q = "輕微", $ = "強調", EE = "清單項目 {0} / {1}", _E = "已勾選", TE = "未選擇", AE = "群組表頭", IE = "多重選擇模式", RE = "項目選擇。", OE = "包含可選擇的項目", LE = "包含可多重選擇的項目", NE = "包含可刪除的項目", SE = "訊息列關閉", CE = "可關閉", DE = "錯誤資訊列", PE = "警告資訊列", BE = "成功資訊列", UE = "資訊列", tE = "確定", nE = "已選擇此值。", sE = "多重值輸入", oE = "更多 ({0} 個)", cE = "展開/收縮", ME = "範圍", GE = "左側控點", KE = "右側控點", VE = "分級", HE = "分級指示碼", XE = "必要", YE = "拒絕", WE = "區段按鈕群組", FE = "按下 SPACE 或 ENTER 以選擇項目", ZE = "區段按鈕", aE = "滑桿控點", eE = "較多", lE = "表頭列 1/{0}", hE = "{0}/{1}", iE = "群組表頭列", dE = "項目選擇", pE = "選擇所有列", fE = "空白", rE = "正面", uE = "負面", JE = "重要", bE = "一般", gE = "含子項目的索引標籤", mE = "下一步", xE = "上一步", zE = "溢位功能表", jE = "更多", kE = "取消", qE = "按向下鍵以開啟子項目功能表", vE = "剩下 {0} 個字元", wE = "超過 {0} 個字元", yE = "小時", QE = "分", $E = "秒", E_ = "成功", __ = "取消", T_ = "時間輸入", A_ = "鐘面", I_ = "持續期輸入", R_ = "日期", O_ = "時間", L_ = "可刪除", N_ = "無記號", S_ = "包含 1 個記號", C_ = "包含 {0} 個記號", D_ = "表徵參數量化器", P_ = "移除", B_ = "{0} 個項目", U_ = "樹狀結構項目", t_ = "展開節點", n_ = "收縮節點", s_ = "值狀態 (錯誤)", o_ = "值狀態 (警告)", c_ = "值狀態 (成功)", M_ = "值狀態資訊", G_ = "無效輸入項", K_ = "已發出警告", V_ = "資訊輸入項", H_ = "已成功驗證輸入項", X_ = "下一步", Y_ = "上一步", W_ = "週數", F_ = "非工作日", Z_ = "今天", a_ = "月份選擇器", e_ = "年份選擇器", l_ = "減少", h_ = "增加", i_ = "分割按鈕", d_ = "按下空格鍵或 Enter 以驅動預設動作，以及 Alt + 向下箭頭或 F4 以驅動箭頭動作", p_ = "返回", f_ = "拒絕", r_ = "互動表頭", u_ = "使用　Shift　+　箭頭鍵以調整大小", J_ = "使用箭頭鍵以移動", b_ = "使用箭頭鍵以移動，使用　Shift　+　箭頭鍵以調整大小", g_ = "：", m_ = "Additional Options", x_ = {
