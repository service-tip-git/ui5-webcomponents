import{x as u}from"./lit-element-c5a2b594.js";import{l as t}from"./if-defined-c29cffe1.js";import{o as c}from"./unsafe-html-0ddd83da.js";import{V as P}from"./ValueState-a555c094.js";import{I as _}from"./InputType-e6e10a5f.js";const k={type:{control:"select",options:["Text","Email","Number","Password","Tel","URL"]},valueState:{control:"select",options:["None","Positive","Critical","Negative","Information"]},default:{control:{type:"text"},table:{type:{summary:"Array<IInputSuggestionItem>"}}},icon:{control:{type:"text"},table:{type:{summary:"Array<IIcon>"}}},valueStateMessage:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},openPicker:{description:"Manually opens the suggestions popover, assuming suggestions are enabled. Items must be preloaded for it to open.",table:{category:"methods"},UI5CustomData:{returnValue:{type:{text:"void"}}}},"selection-change":{description:`Fired when the user navigates to a suggestion item via the ARROW keys,
as a preview, before the final selection.`,control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"HTMLElement"},name:"item",_ui5privacy:"public",description:"The previewed suggestion item."},{type:{text:"HTMLElement"},name:"targetRef",_ui5privacy:"public",description:"The DOM ref of the suggestion item."}]}}},Q={package:"@ui5/webcomponents",tagName:"ui5-input"};var p=Object.freeze,A=Object.defineProperty,q=(n,N)=>p(A(n,"raw",{value:p(N||n.slice())})),g,m;let e=0;const R={title:"Main/Input",component:"Input",argTypes:k},d=n=>u`
<ui5-input
    id="input-${++e}"
...
<\/script>`])),n(),e,e,e,e,e,e,e)];a.args={placeholder:"Start typing country name",showSuggestions:!0,showClearIcon:!0};const o=d.bind({});o.args={default:`<ui5-suggestion-item text="Wireless DSL/ Repeater and Print Server Lorem ipsum dolar st amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor incidunt ut labore et dolore magna aliquyam erat, diam nonumy eirmod tempor individunt ut labore et dolore magna aliquyam erat, sed justo et ea rebum."></ui5-suggestion-item>
    ...
    <ui5-li>Condensed</ui5-li>`,placeholder:"Choose content density",showSuggestions:!0,valueState:P.Negative,valueStateMessage:'<div slot="valueStateMessage">This is an negative message. Extra long text used as an negative message.</div>'};const i=d.bind({});i.decorators=[n=>u`
            <ui5-label class="samples-big-margin-right" for="input-${e+1}" required="" show-colon="">Secret Code</ui5-label>
            ${n()}
        `];i.args={type:_.Password,placeholder:"Enter your Secret Code",required:!0};const l=()=>u(m||(m=q([`
...
</ui5-input>\``,...(v=(h=s.parameters)==null?void 0:h.docs)==null?void 0:v.source}}};var $,y,I;a.parameters={...a.parameters,docs:{...($=a.parameters)==null?void 0:$.docs,source:{originalSource:`args => html\`
<ui5-input
    id="input-\${++index}"
    ?disabled="\${ifDefined(args.disabled)}"
    placeholder="\${ifDefined(args.placeholder)}"
...
<\/script>
\``,...(B=(M=l.parameters)==null?void 0:M.docs)==null?void 0:B.source}}};const j=["Basic","Suggestions","SuggestionsWrapping","ValueStateMessage","Label","ValueHelpDialog"],F=Object.freeze(Object.defineProperty({__proto__:null,Basic:s,Label:i,Suggestions:a,SuggestionsWrapping:o,ValueHelpDialog:l,ValueStateMessage:r,__namedExportsOrder:j,default:R},Symbol.toStringTag,{value:"Module"}));export{F as C,Q as c};
