...
function App() {
  ...
  const handleCol1ItemClick = useCallback(
  ...
  const handleCol2ItemClick = useCallback(
    (e: UI5CustomEvent<ListClass, "item-click">) => {
  ...
  const handleToggleClick = useCallback(
    (e: UI5CustomEvent<ToggleButtonClass, "click">) => {
      const pressed = e.currentTarget.pressed;
    ...
    <>
      ...
      <FlexibleColumnLayout ref={fclRef} class="fcl" layout={layout}>
        <div className="col" slot="startColumn">
          ...
          <List
            headerText="Products (13)"
            selectionMode="Single"
            onItemClick={handleCol1ItemClick}
          >
            <ListItemStandard
              description="HT-2001"
        ...
        <div className="col" slot="midColumn">
          <div className="colHeader">
            <Title level="H2" style={{ minWidth: "1px" }}>
              {col2Title}
            </Title>
            <div className="colSubHeader">
              ...
              <Button
                design="Transparent"
                icon={midFullscreenIcon}
                onClick={handleFullscreenMidColumn}
              />
              <Button
                icon="decline"
                design="Transparent"
                onClick={handleCloseMidColumn}
              />
            </div>
          </div>
          <br />
          <section style={{ padding: "1rem 1rem" }}>
            ...
            <List onItemClick={handleCol2ItemClick}>
              <ListItemStandard icon="slim-arrow-right" iconEnd={true}>
                Titanium
              </ListItemStandard>
              <ListItemStandard icon="slim-arrow-right" iconEnd={true}>
                Technocom
        ...
        <div className="col" slot="endColumn">
          <div className="colHeader">
            ...
            <div className="colSubHeader">
              ...
              <Button
                design="Transparent"
                icon={endFullscreenIcon}
                onClick={handleFullscreenEndColumn}
              />
              <Button
                icon="decline"
                design="Transparent"
                onClick={handleCloseEndColumn}
              />
            </div>
          </div>
          <br />
