import{x as n}from"./lit-element.3a4d34a1.js";import{D as _}from"./docs.68158459.js";import{l as t}from"./if-defined.d89d00ab.js";import{o as d}from"./unsafe-html.3b27b0e6.js";import{a as U,T as A}from"./TableGrowingMode.77e95459.js";import"./index.bdfa8201.js";import"./_commonjsHelpers.b8add541.js";import"./chunk-PCJTTTQV.fff2aeb1.js";import"./iframe.dc5c819b.js";import"../sb-preview/runtime.js";import"./client.69b06123.js";import"./index.bf7d2e87.js";import"./index.5ca63ce8.js";import"./index.5f460d07.js";import"./index.d612502e.js";import"./index.b38f6aa4.js";const j={growing:{control:"select",options:["Button","None","Scroll"]},mode:{control:"select",options:["MultiSelect","None","SingleSelect"]},columns:{control:{type:"text"}},default:{control:{type:"text"}},"popin-change":{description:"Fired when <code>ui5-table-column</code> is shown as a pop-in instead of hiding it.",table:{category:"events"},UI5CustomData:{parameters:[{name:"poppedColumns",type:"Array",description:"popped-in columns."}]}},"row-click":{description:"Fired when a row in <code>Active</code> mode is clicked or <code>Enter</code> key is pressed.",table:{category:"events"},UI5CustomData:{parameters:[{name:"row",type:"HTMLElement",description:"the activated row."}]}},"selection-change":{description:"Fired when selection is changed by user interaction in <code>SingleSelect</code> and <code>MultiSelect</code> modes.",table:{category:"events"},UI5CustomData:{parameters:[{name:"selectedRows",type:"Array",description:"An array of the selected rows."},{name:"previouslySelectedRows",type:"Array",description:"An array of the previously selected rows."}]}}},K={package:"@ui5/webcomponents"};var p=Object.freeze,V=Object.defineProperty,E=(l,W)=>p(V(l,"raw",{value:p(W||l.slice())})),g,m;const O="ui5-table";let e=0;const re={title:"Main/Table",component:"Table",subcomponents:{TableColumn:"TableColumn",TableRow:"TableRow",TableGroupRow:"TableGroupRow",TableCell:"TableCell"},parameters:{docs:{page:_({...K,component:O})}},argTypes:j},o=l=>n`
<ui5-table
    id="table-${++e}"
...
\``,...(P=(G=b.parameters)==null?void 0:G.docs)==null?void 0:P.source}}};const ce=["Basic","PopinDisplayInline","StickyHeader","NoData","GrowingTableMoreButton","GrowingTableScroll","GroupingTableSelect"];export{r as Basic,b as GroupingTableSelect,i as GrowingTableMoreButton,s as GrowingTableScroll,a as NoData,c as PopinDisplayInline,u as StickyHeader,ce as __namedExportsOrder,re as default};
//# sourceMappingURL=Table.stories.37628b4b.js.map
