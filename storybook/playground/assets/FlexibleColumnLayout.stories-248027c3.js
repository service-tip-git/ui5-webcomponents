...
or by changing the component size due to resizing.`,control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"FCLLayout",references:[{name:"FCLLayout",package:"@ui5/webcomponents-fiori",module:"dist/types/FCLLayout.js"}]},name:"layout",_ui5privacy:"public",description:"The current layout"},{type:{text:"array"},name:"columnLayout",_ui5privacy:"public",description:"The effective column layout, f.e [67%, 33%, 0]"},{type:{text:"boolean"},name:"startColumnVisible",_ui5privacy:"public",description:"Indicates if the start column is currently visible"},{type:{text:"boolean"},name:"midColumnVisible",_ui5privacy:"public",description:"Indicates if the middle column is currently visible"},{type:{text:"boolean"},name:"endColumnVisible",_ui5privacy:"public",description:"Indicates if the end column is currently visible"},{type:{text:"boolean"},name:"arrowsUsed",_ui5privacy:"public",description:"Indicates if the layout is changed via the arrows"},{type:{text:"boolean"},name:"resize",_ui5privacy:"public",description:"Indicates if the layout is changed via resizing"}]}}},v={package:"@ui5/webcomponents-fiori",since:"1.0.0-rc.8",tagName:"ui5-flexible-column-layout"};var l=Object.freeze,m=Object.defineProperty,p=(e,c)=>l(m(e,"raw",{value:l(c||e.slice())})),o;const f={title:"Fiori/Flexible Column Layout",component:"FlexibleColumnLayout",argTypes:s},b=e=>d(o||(o=p([` <style>
    ...
    <\/script>`])),i(e.layout),i(e.hideArrows),i(e.accessibilityAttributes),t(e.startColumn),t(e.midColumn),t(e.endColumn)),n=b.bind({});n.args={startColumn:`
      ...
      </div>`};n.parameters={docs:{story:{inline:!1,iframeHeight:600}}};var r,a,u;n.parameters={...n.parameters,docs:{...(r=n.parameters)==null?void 0:r.docs,source:{originalSource:`args => {
  return html\` <style>
      .col {
        height: 100%;
      }
    ...
    <\/script>\`;
}`,...(u=(a=n.parameters)==null?void 0:a.docs)==null?void 0:u.source}}};const x=["Basic"],C=Object.freeze(Object.defineProperty({__proto__:null,Basic:n,__namedExportsOrder:x,default:f},Symbol.toStringTag,{value:"Module"}));export{C,v as c};
