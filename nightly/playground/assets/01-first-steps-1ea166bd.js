...
`,e.jsxs(n.p,{children:["Take a look at the available UI5 Web Components documentation in the ",e.jsx(n.a,{href:"./?path=/docs/docs-getting-started-playground-docs---docs",children:"playground"}),"."]}),`
...
`,e.jsxs(n.p,{children:["Next: ",e.jsx(n.a,{href:"./?path=/docs/docs-getting-started-importing-components--docs",children:"Importing UI5 Web Components"})]}),`
`,e.jsx(r,{})]})}function f(s={}){const{wrapper:n}=Object.assign({},t(),s.components);return n?e.jsx(n,Object.assign({},s,{children:e.jsx(o,s)})):o(s)}export{f as default};
//# sourceMappingURL=01-first-steps-1ea166bd.js.map
