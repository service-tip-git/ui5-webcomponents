import{x as k}from"./lit-element-c5a2b594.js";import{l as t}from"./if-defined-c29cffe1.js";import{o as y}from"./unsafe-html-0ddd83da.js";import{D as w}from"./docs-8e089256.js";import{T as L}from"./TabLayout-8f6a62b3.js";import"./jsx-runtime-5fc188ad.js";import"./index-c0290abd.js";import"./_commonjsHelpers-725317a4.js";import"./Footer-e0f90e05.js";import"./index-962da13e.js";import"./iframe-b9ad3337.js";import"../sb-preview/runtime.js";import"./index-d475d2ea.js";import"./index-d37d4223.js";import"./index-d38538b0.js";import"./index-356e4a49.js";import"./chunk-PCJTTTQV-9bd52cb7.js";import"./client-295e1f1c.js";const B={allItems:{control:{type:!1}},contentBackgroundDesign:{control:"select",options:["Solid","Translucent","Transparent"]},headerBackgroundDesign:{control:"select",options:["Solid","Translucent","Transparent"]},tabLayout:{control:"select",options:["Inline","Standard"]},tabsOverflowMode:{control:"select",options:["End","StartAndEnd"]},default:{control:{type:"text"}},overflowButton:{control:{type:"text"}},startOverflowButton:{control:{type:"text"}},"tab-select":{description:"Fired when a tab is selected.",table:{category:"events"},UI5CustomData:{parameters:[{name:"tab",type:"HTMLElement",description:"The selected <code>tab</code>."},{name:"tabIndex",type:"Integer",description:"The selected <code>tab</code> index in the flattened array of all tabs and their subTabs, provided by the <code>allItems</code> getter."}]}}},O={package:"@ui5/webcomponents"},S="ui5-tabcontainer",J={title:"Main/Tab Container",component:"TabContainer",subcomponents:{Tab:"Tab",TabSeparator:"TabSeparator"},parameters:{docs:{page:w({...O,component:S})}},argTypes:B},s=e=>k`<ui5-tabcontainer
    ?fixed="${t(e.fixed)}"
...
<ui5-tab text="Tab 23"></ui5-tab>`};const o=s.bind({});o.args={tabLayout:L.Inline,collapsed:!0,fixed:!0,default:`<ui5-tab icon="laptop" text="Monitors" additional-text="10"></ui5-tab>
...
}`,...(D=(T=o.parameters)==null?void 0:T.docs)==null?void 0:D.source}}};var h,$,v;r.parameters={...r.parameters,docs:{...(h=r.parameters)==null?void 0:h.docs,source:{originalSource:`args => {
  return html\`<ui5-tabcontainer
    ?fixed="\${ifDefined(args.fixed)}"
    ?collapsed="\${ifDefined(args.collapsed)}"
    tab-layout="\${ifDefined(args.tabLayout)}"
...
}`,...(v=($=r.parameters)==null?void 0:$.docs)==null?void 0:v.source}}};const K=["Basic","TextOnlyTabs","TextOnlyEndOverflow","InlineTabLayout","NestedTabs"];export{a as Basic,o as InlineTabLayout,r as NestedTabs,n as TextOnlyEndOverflow,i as TextOnlyTabs,K as __namedExportsOrder,J as default};
//# sourceMappingURL=TabContainer.stories-50dd3b1c.js.map
