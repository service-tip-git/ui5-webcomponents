  ...
  return (
    <>
      <Button id="colorPaletteBtn" onClick={() => setOpen(!open)}>Open ColorPalettePopover</Button>
        ...
        <ColorPalettePopover open={open} id="colorPalettePopover" opener="colorPaletteBtn" showRecentColors={true} showMoreColors={true} showDefaultColor={true} defaultColor="orange" onClose={() => setOpen(false)}
        >
