...
function App() {
  return (
    <>
      ...
      <br />
      <br />
      <StepInput readonly={true} value={5} />
      <br />
      <br />
      <StepInput valueState="Positive" value={5} />
      <br />
      <br />
      <StepInput valueState="Information" value={5} />
      <br />
      <br />
      <StepInput valueState="Critical" value={5} />
      <br />
      <br />
      <StepInput valueState="Negative" value={5} />
      <br />
      <br />
      <StepInput
        valueState="Negative"
