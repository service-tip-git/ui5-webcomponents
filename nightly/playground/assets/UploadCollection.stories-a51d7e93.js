...
<\/script>`])),e()),i=p.bind({});i.args={mode:k.Delete,id:"uploadCollection",accessibleName:"Uploaded (2)",header:`<div slot="header" class="header">
...
${a("Notes.txt",!1,t.Complete,"Uploaded By: John Smith · Uploaded On: 2014-09-02 · File Size: 226.6 KB",'<ui5-icon name="document-text" slot="thumbnail"></ui5-icon>')}`};i.parameters={docs:{story:{iframeHeight:"500px"}}};i.decorators=[M,B,u];const W=e=>r(y||(y=s(["",`
...
${a("Notes.txt",!1,t.Ready,'uploadState="Ready" (default)','<ui5-icon name="document-text" slot="thumbnail"></ui5-icon>')}`};n.parameters={docs:{story:{iframeHeight:"400px"}}};n.decorators=[X,u];const Y=e=>r(T||(T=s(["",`
...
</div>`};o.parameters={docs:{story:{iframeHeight:"500px"}}};o.decorators=[M,B,Y,u];var U,S,x;i.parameters={...i.parameters,docs:{...(U=i.parameters)==null?void 0:U.docs,source:{originalSource:`args => {
  return html\`
<ui5-upload-collection
...
}`,...(x=(S=i.parameters)==null?void 0:S.docs)==null?void 0:x.source}}};var L,E,H;d.parameters={...d.parameters,docs:{...(L=d.parameters)==null?void 0:L.docs,source:{originalSource:`args => {
  return html\`
<ui5-upload-collection
    id="\${ifDefined(args.id)}"
    mode="\${ifDefined(args.mode)}"
...
}`,...(H=(E=d.parameters)==null?void 0:E.docs)==null?void 0:H.source}}};var N,w,I;n.parameters={...n.parameters,docs:{...(N=n.parameters)==null?void 0:N.docs,source:{originalSource:`args => {
  return html\`
<ui5-upload-collection
    id="\${ifDefined(args.id)}"
    mode="\${ifDefined(args.mode)}"
...
}`,...(F=(_=o.parameters)==null?void 0:_.docs)==null?void 0:F.source}}};const $e=["Basic","RenamingFiles","VariousUploadStates","DragAndDrop"];export{i as Basic,o as DragAndDrop,d as RenamingFiles,n as VariousUploadStates,$e as __namedExportsOrder,De as default};
//# sourceMappingURL=UploadCollection.stories-a51d7e93.js.map
