import{x as s}from"./lit-element.3a4d34a1.js";import{l as i}from"./if-defined.d89d00ab.js";import{o as t}from"./unsafe-html.3b27b0e6.js";import{D as d}from"./docs.bdde397f.js";import"./index.bdfa8201.js";import"./_commonjsHelpers.b8add541.js";import"./chunk-PCJTTTQV.f2d507d7.js";import"./iframe.14019a4b.js";import"../sb-preview/runtime.js";import"./client.69b06123.js";import"./index.e1463e17.js";import"./index.5ca63ce8.js";import"./index.5f460d07.js";import"./index.d612502e.js";import"./index.b38f6aa4.js";const m={columnLayout:{control:{type:!1}},endColumnVisible:{control:{type:!1}},layout:{control:"select",options:["EndColumnFullScreen","MidColumnFullScreen","OneColumn","ThreeColumnsEndExpanded","ThreeColumnsMidExpanded","ThreeColumnsMidExpandedEndHidden","ThreeColumnsStartExpandedEndHidden","TwoColumnsMidExpanded","TwoColumnsStartExpanded"]},midColumnVisible:{control:{type:!1}},startColumnVisible:{control:{type:!1}},visibleColumns:{control:{type:!1}},endColumn:{control:{type:"text"}},midColumn:{control:{type:"text"}},startColumn:{control:{type:"text"}},"layout-change":{description:"Fired when the layout changes via user interaction by clicking the arrows or by changing the component size due to resizing.",table:{category:"events"},UI5CustomData:{parameters:[{name:"layout",type:"sap.ui.webc.fiori.types.FCLLayout",description:"The current layout"},{name:"columnLayout",type:"array",description:"The effective column layout, f.e [67%, 33%, 0]"},{name:"startColumnVisible",type:"boolean",description:"Indicates if the start column is currently visible"},{name:"midColumnVisible",type:"boolean",description:"Indicates if the middle column is currently visible"},{name:"endColumnVisible",type:"boolean",description:"Indicates if the end column is currently visible"},{name:"arrowsUsed",type:"boolean",description:"Indicates if the layout is changed via the arrows"},{name:"resize",type:"boolean",description:"Indicates if the layout is changed via resizing"}]}}},p={package:"@ui5/webcomponents-fiori",since:"1.0.0-rc.8"};var l=Object.freeze,f=Object.defineProperty,b=(e,u)=>l(f(e,"raw",{value:l(u||e.slice())})),o;const x="ui5-flexible-column-layout",R={title:"Fiori/FlexibleColumnLayout",component:"FlexibleColumnLayout",parameters:{docs:{page:d({...p,component:x})}},argTypes:m},g=e=>s(o||(o=b([` <style>
      .col {
        height: 100%;
      }
      .colHeader {
  ...
  return html\` <style>
    ...
    <\/script>\`;
}`,...(c=(a=n.parameters)==null?void 0:a.docs)==null?void 0:c.source}}};const B=["Basic"];export{n as Basic,B as __namedExportsOrder,R as default};
//# sourceMappingURL=FlexibleColumnLayout.stories.887d0e41.js.map
