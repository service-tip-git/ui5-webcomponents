import{x as u}from"./lit-element-c5a2b594.js";import{D as d}from"./docs-d97efe99.js";import{o as h}from"./unsafe-html-0ddd83da.js";import{l as v}from"./if-defined-c29cffe1.js";import"./jsx-runtime-670e1be8.js";import"./index-4e9ba9b8.js";import"./_commonjsHelpers-725317a4.js";import"./Footer-a7ea689a.js";import"./index-53d09975.js";import"./iframe-35a4826c.js";import"../sb-preview/runtime.js";import"./index-11d98b33.js";import"./index-d38538b0.js";import"./index-356e4a49.js";import"./chunk-HLWAVYOI-d1983070.js";import"./client-fb0f3103.js";const E={default:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},header:{control:{type:"text"},table:{type:{summary:"Array<ICardHeader>"}}}},p={package:"@ui5/webcomponents"},b="ui5-card",ee={title:"Main/Card",component:"Card",parameters:{docs:{page:d({...p,component:b}),story:{iframeHeight:"370px",inline:!1}}},argTypes:E},o=e=>u`
<ui5-card
...
</ui5-table>`};a.decorators=[m("40rem")];a.parameters={docs:{page:d({...p,component:b}),story:{iframeHeight:"250px",inline:!1}}};const r=o.bind({});r.args={header:i("Upcoming Activities","Today"),default:`<ui5-timeline>
...
</ui5-timeline>`};r.decorators=[m("22rem")];const s=o.bind({}),U=[{header:i("David Williams","Sales Manager"),default:`<ui5-list separators="Inner" style="margin-block-end: 0.75rem;">
    ...
    <div class="content-group">
        ...
        <ui5-link target="_blank">www.company_a.example.com</ui5-link>
            ...
            <div class="grid-container">
                ${U.map(n=>e({args:{...n}}))}
            </div>`];s.parameters={docs:{page:d({...p,component:b}),story:{iframeHeight:"680px",inline:!1}}};var y,$,w;t.parameters={...t.parameters,docs:{...(y=t.parameters)==null?void 0:y.docs,source:{originalSource:`args => {
  return html\`
<ui5-card
...
>
    ...
    \`;
}`,...(w=($=t.parameters)==null?void 0:$.docs)==null?void 0:w.source}}};var S,T,x;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:`args => {
  return html\`
<ui5-card
    accessible-name="\${ifDefined(args.accessibleName)}"
    accessible-name-ref="\${ifDefined(args.accessibleNameRef)}"
>
    ...
    \`;
}`,...(x=(T=l.parameters)==null?void 0:T.docs)==null?void 0:x.source}}};var D,M,_;a.parameters={...a.parameters,docs:{...(D=a.parameters)==null?void 0:D.docs,source:{originalSource:`args => {
  return html\`
<ui5-card
    accessible-name="\${ifDefined(args.accessibleName)}"
    accessible-name-ref="\${ifDefined(args.accessibleNameRef)}"
>
    ...
    \`;
}`,...(_=(M=a.parameters)==null?void 0:M.docs)==null?void 0:_.source}}};var k,H,N;r.parameters={...r.parameters,docs:{...(k=r.parameters)==null?void 0:k.docs,source:{originalSource:`args => {
  return html\`
<ui5-card
    accessible-name="\${ifDefined(args.accessibleName)}"
    accessible-name-ref="\${ifDefined(args.accessibleNameRef)}"
>
    ...
    \`;
}`,...(N=(H=r.parameters)==null?void 0:H.docs)==null?void 0:N.source}}};var A,R,C;s.parameters={...s.parameters,docs:{...(A=s.parameters)==null?void 0:A.docs,source:{originalSource:`args => {
  return html\`
<ui5-card
    accessible-name="\${ifDefined(args.accessibleName)}"
    accessible-name-ref="\${ifDefined(args.accessibleNameRef)}"
>
    ...
    \`;
}`,...(C=(R=s.parameters)==null?void 0:R.docs)==null?void 0:C.source}}};const ae=["InteractiveHeader","WithList","WithTable","WithTimeline","More"];export{t as InteractiveHeader,s as More,l as WithList,a as WithTable,r as WithTimeline,ae as __namedExportsOrder,ee as default};
