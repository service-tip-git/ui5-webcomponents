...
>
    ${m(n.icon)}
    ${m(n.default)}
</ui5-badge>`,s=a.bind({});s.args={colorScheme:"6",default:"Badge Text"};const o=a.bind({});o.args={design:r.Positive,interactive:!0,default:"Positive"};const d=a.bind({});d.decorators=[(n,{args:e})=>l`
...
}`,...(w=(b=d.parameters)==null?void 0:b.docs)==null?void 0:w.source}}};var M,I,L;c.parameters={...c.parameters,docs:{...(M=c.parameters)==null?void 0:M.docs,source:{originalSource:`args => {
  return html\`
<ui5-badge
    design="\${ifDefined(args.design)}"
    color-scheme="\${ifDefined(args.colorScheme)}"
...
}`,...(L=(I=c.parameters)==null?void 0:I.docs)==null?void 0:L.source}}};var H,x,N;g.parameters={...g.parameters,docs:{...(H=g.parameters)==null?void 0:H.docs,source:{originalSource:`args => {
  return html\`
<ui5-badge
    design="\${ifDefined(args.design)}"
    color-scheme="\${ifDefined(args.colorScheme)}"
...
}`,...(O=(W=p.parameters)==null?void 0:W.docs)==null?void 0:O.source}}};const A=["Basic","Interactive","WrappingTypes","Designs","Set1","Set2","Set3"],K=Object.freeze(Object.defineProperty({__proto__:null,Basic:s,Designs:c,Interactive:o,Set1:g,Set2:f,Set3:p,WrappingTypes:d,__namedExportsOrder:A,default:z},Symbol.toStringTag,{value:"Module"}));export{K as C,J as c};
