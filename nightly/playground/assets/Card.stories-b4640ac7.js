...
</ui5-table>`};a.decorators=[d("40rem")];a.parameters={docs:{page:p({...b,component:g}),story:{iframeHeight:"250px",inline:!1}}};const s=o.bind({});s.args={header:i("Upcoming Activities","Today"),default:`<ui5-timeline>
...
</ui5-timeline>`};s.decorators=[d("22rem")];const r=o.bind({}),E=[{header:i("David Williams","Sales Manager"),default:`<ui5-list separators="Inner">
    ...
    <div class="content-group">
        ...
        <ui5-link target="_blank">www.company_a.example.com</ui5-link>
            ...
            <div class="grid-container">
                ${E.map(n=>e({args:{...n}}))}
            </div>`];r.parameters={docs:{page:p({...b,component:g}),story:{iframeHeight:"680px",inline:!1}}};var $,y,w;t.parameters={...t.parameters,docs:{...($=t.parameters)==null?void 0:$.docs,source:{originalSource:`args => {
  return html\`
<ui5-card
...
>
    ...
    \`;
}`,...(_=(M=a.parameters)==null?void 0:M.docs)==null?void 0:_.source}}};var H,N,R;s.parameters={...s.parameters,docs:{...(H=s.parameters)==null?void 0:H.docs,source:{originalSource:`args => {
  return html\`
<ui5-card
    accessible-name="\${ifDefined(args.accessibleName)}"
    accessible-name-ref="\${ifDefined(args.accessibleNameRef)}"
>
    ...
    \`;
}`,...(R=(N=s.parameters)==null?void 0:N.docs)==null?void 0:R.source}}};var k,C,A;r.parameters={...r.parameters,docs:{...(k=r.parameters)==null?void 0:k.docs,source:{originalSource:`args => {
  return html\`
<ui5-card
    accessible-name="\${ifDefined(args.accessibleName)}"
    accessible-name-ref="\${ifDefined(args.accessibleNameRef)}"
...
//# sourceMappingURL=Card.stories-b4640ac7.js.map
