...
const getScripts = (options) => {
	...
	const scripts = {
		...
		"test-cy-ci-suite-1": `cross-env TEST_SUITE=SUITE1 yarn cypress run --component --browser chrome`,
		"test-cy-ci-suite-2": `cross-env TEST_SUITE=SUITE2 yarn cypress run --component --browser chrome`,
		"test-cy-ci-suite-3": `cross-env TEST_SUITE=SUITE3 yarn cypress run --component --browser chrome`,
		"test-cy-ci-suite-4": `cross-env TEST_SUITE=SUITE4 yarn cypress run --component --browser chrome`,
