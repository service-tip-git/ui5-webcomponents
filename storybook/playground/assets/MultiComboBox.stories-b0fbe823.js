import{x as S}from"./lit-element-c5a2b594.js";import{o as m}from"./unsafe-html-0ddd83da.js";import{l as i}from"./if-defined-c29cffe1.js";import{V as T}from"./ValueState-a555c094.js";const C={valueState:{control:"select",options:["None","Positive","Critical","Negative","Information"]},filter:{control:"select",options:["StartsWithPerTerm","StartsWith","Contains","None"]},open:{control:{type:!1}},default:{control:{type:"text"},table:{type:{summary:"Array<IMultiComboBoxItem>"}}},icon:{control:{type:"text"},table:{type:{summary:"Array<IIcon>"}}},valueStateMessage:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},"selection-change":{description:"Fired when selection is changed by user interaction.",control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"Array<IMultiComboBoxItem>",references:[{name:"IMultiComboBoxItem",package:"@ui5/webcomponents",module:"dist/MultiComboBox.js"}]},name:"items",_ui5privacy:"public",description:"an array of the selected items."}]}}},V={package:"@ui5/webcomponents",since:"0.11.0",tagName:"ui5-multi-combobox"},N={title:"Main/Multi-Combo Box",component:"MultiComboBox",argTypes:C},s=e=>S`
<ui5-multi-combobox
    value="${i(e.value)}"
...
>
    ...
    \${unsafeHTML(args.icon)}
    \${unsafeHTML(args.valueStateMessage)}
</ui5-multi-combobox>\``,...(M=(h=r.parameters)==null?void 0:h.docs)==null?void 0:M.source}}};const L=["Basic","MultiComboBoxCustomValue","MultiComboBoxGrouping","MultiComboBoxLongToken","SuggestionsWrapping"],P=Object.freeze(Object.defineProperty({__proto__:null,Basic:o,MultiComboBoxCustomValue:a,MultiComboBoxGrouping:t,MultiComboBoxLongToken:n,SuggestionsWrapping:r,__namedExportsOrder:L,default:N},Symbol.toStringTag,{value:"Module"}));export{P as C,V as c};
