...
<\/script>`])),n(),e,e,e,e,e,e,e)];a.args={placeholder:"Start typing country name",showSuggestions:!0,showClearIcon:!0};const o=d.bind({});o.args={default:`<ui5-suggestion-item text="Wireless DSL/ Repeater and Print Server Lorem ipsum dolar st amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor incidunt ut labore et dolore magna aliquyam erat, diam nonumy eirmod tempor individunt ut labore et dolore magna aliquyam erat, sed justo et ea rebum."></ui5-suggestion-item>
    ...
    <ui5-li>Condensed</ui5-li>`,placeholder:"Choose content density",showSuggestions:!0,valueState:A.Error,valueStateMessage:'<div slot="valueStateMessage">This is an error message. Extra long text used as an error message.</div>'};const i=d.bind({});i.decorators=[n=>u`
            <ui5-label class="samples-big-margin-right" for="input-${e+1}" required="" show-colon="">Secret Code</ui5-label>
            ${n()}
        `];i.args={type:N.Password,placeholder:"Enter your Secret Code",required:!0};const l=()=>u(m||(m=q([`
...
<\/script>
\``,...(B=(M=l.parameters)==null?void 0:M.docs)==null?void 0:B.source}}};const re=["Basic","Suggestions","SuggestionsWrapping","ValueStateMessage","Label","ValueHelpDialog"];export{s as Basic,i as Label,a as Suggestions,o as SuggestionsWrapping,l as ValueHelpDialog,r as ValueStateMessage,re as __namedExportsOrder,oe as default};
