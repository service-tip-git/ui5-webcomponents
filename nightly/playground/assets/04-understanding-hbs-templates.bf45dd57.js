...
`,e.exports.jsx(s.h2,{id:"table-of-contents",children:"Table of contents"}),`
...
`]}),`
`]}),`
`,e.exports.jsxs(s.h2,{id:"1-handlebars-compilation-",children:["1. Handlebars compilation ",e.exports.jsx("a",{name:"compilation"})]}),`
`,e.exports.jsxs(s.p,{children:[e.exports.jsx(s.a,{href:"https://handlebarsjs.com/guide/#simple-expressions",target:"_blank",rel:"nofollow noopener noreferrer",children:"Handlebars"})," templates (",e.exports.jsx(s.code,{children:".hbs"}),") are compiled during build/development to ",e.exports.jsx(s.a,{href:"https://lit.dev/docs/v1/lit-html/introduction/",target:"_blank",rel:"nofollow noopener noreferrer",children:"lit-html"})," templates (",e.exports.jsx(s.code,{children:".lit.js"}),") and the lit templates are what's actually executed during runtime."]}),`
...
`,e.exports.jsxs(s.h2,{id:"2-design-goals-of-the-handlebars-templates-",children:["2. Design goals of the Handlebars templates ",e.exports.jsx("a",{name:"design_goals"})]}),`
`,e.exports.jsxs(s.ul,{children:[`
...
`,e.exports.jsxs(s.h2,{id:"3-the-context-in-hbs-files-",children:["3. The context in ",e.exports.jsx(s.code,{children:".hbs"})," files ",e.exports.jsx("a",{name:"context"})]}),`
`,e.exports.jsxs(s.h3,{id:"31-global-context-",children:["3.1 Global context ",e.exports.jsx("a",{name:"context_global"})]}),`
...
`,e.exports.jsxs(s.h3,{id:"32-context-in-loops--",children:["3.2 Context in loops  ",e.exports.jsx("a",{name:"context_loops"})]}),`
...
`,e.exports.jsxs(s.h3,{id:"33-accessing-the-global-context-from-loops--",children:["3.3 Accessing the global context from loops  ",e.exports.jsx("a",{name:"context_loops_accessing"})]}),`
...
`,e.exports.jsxs(s.h2,{id:"4-the-hbs-syntax-",children:["4. The ",e.exports.jsx(s.code,{children:".hbs"})," syntax ",e.exports.jsx("a",{name:"syntax"})]}),`
`,e.exports.jsxs(s.p,{children:["You can use the following features when writing ",e.exports.jsx(s.code,{children:".hbs"})," templates:"]}),`
`,e.exports.jsxs(s.h3,{id:"bindings-",children:["Bindings ",e.exports.jsx("a",{name:"syntax_bindings"})]}),`
...
`,e.exports.jsxs(s.h3,{id:"conditions-",children:["Conditions ",e.exports.jsx("a",{name:"syntax_conditional"})]}),`
...
{{/if}}
`})}),`
`,e.exports.jsxs(s.h3,{id:"loops-",children:["Loops ",e.exports.jsx("a",{name:"syntax_loops"})]}),`
...
`})}),`
`,e.exports.jsxs(s.p,{children:["This is a common technique to create unique ",e.exports.jsx(s.a,{href:"https://developer.mozilla.org/en-US/docs/Web/CSS/::part",target:"_blank",rel:"nofollow noopener noreferrer",children:"shadow parts"}),` for items
within a UI5 Web Component.`]}),`
`,e.exports.jsxs(s.h3,{id:"property-assignment-the--prefix-",children:["Property assignment (the ",e.exports.jsx(s.code,{children:"."})," prefix) ",e.exports.jsx("a",{name:"syntax_dot"})]}),`
...
`,e.exports.jsxs(s.h3,{id:"boolean-attribute-assignment-the--prefix-",children:["Boolean attribute assignment (the ",e.exports.jsx(s.code,{children:"?"})," prefix) ",e.exports.jsx("a",{name:"syntax_question_mark"})]}),`
...
`,e.exports.jsxs(s.h3,{id:"event-handlers-assignment-the--prefix-",children:["Event handlers assignment (the ",e.exports.jsx(s.code,{children:"@"})," prefix) ",e.exports.jsx("a",{name:"syntax_at"})]}),`
...
`})}),`
`,e.exports.jsxs(s.h3,{id:"style-maps-",children:["Style maps ",e.exports.jsx("a",{name:"syntax_style_maps"})]}),`
...
`,e.exports.jsxs(s.h3,{id:"class-maps-",children:["Class maps ",e.exports.jsx("a",{name:"syntax_class_maps"})]}),`
...
`,e.exports.jsxs(s.h3,{id:"partials-",children:["Partials ",e.exports.jsx("a",{name:"syntax_partials"})]}),`
...
`,e.exports.jsxs(s.h3,{id:"include-",children:["Include ",e.exports.jsx("a",{name:"syntax_include"})]}),`
...
`,e.exports.jsxs(s.h2,{id:"5-using-the-slot-element-",children:["5. Using the ",e.exports.jsx(s.code,{children:"slot"})," element ",e.exports.jsx("a",{name:"slots"})]}),`
`,e.exports.jsxs(s.h3,{id:"rendering-slots-",children:["Rendering slots ",e.exports.jsx("a",{name:"slots_rendering"})]}),`
`,e.exports.jsxs(s.p,{children:["The ",e.exports.jsx(s.a,{href:"https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot",target:"_blank",rel:"nofollow noopener noreferrer",children:"slot"}),` element allows you to render children, nested in your web component, in a desired place in the shadow DOM.
You should render each slot, defined in your component's metadata (see `,e.exports.jsx(s.a,{href:"./?path=/docs/docs-development-understanding-components-metadata--docs",children:"Understanding UI5 Web Components Metadata"}),"), somewhere in the ",e.exports.jsx(s.code,{children:".hbs"})," template."]}),`
...
`,e.exports.jsxs(s.h3,{id:"individual-slots-",children:["Individual slots ",e.exports.jsx("a",{name:"slots_individual"})]}),`
...
`,e.exports.jsxs(s.p,{children:["The ",e.exports.jsx(s.code,{children:"individualSlots"})," slot metadata configuration setting (see ",e.exports.jsx(s.a,{href:"./?path=/docs/docs-development-understanding-components-metadata--docs",children:"Understanding UI5 Web Components Metadata"}),") allows you to have a separate physical slot for each child belonging to a certain slot."]}),`
...
`,e.exports.jsxs(s.p,{children:["Next: ",e.exports.jsx(s.a,{href:"./?path=/docs/docs-development-testing-ui5-web-components--docs",children:"Testing UI5 Web Components"})]})]})}function g(t={}){const{wrapper:s}=Object.assign({},o(),t.components);return s?e.exports.jsx(s,Object.assign({},t,{children:e.exports.jsx(n,t)})):n(t)}export{g as default};
//# sourceMappingURL=04-understanding-hbs-templates.bf45dd57.js.map
