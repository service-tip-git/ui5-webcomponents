import{j as e}from"./jsx-runtime.97c1caca.js";import{M as n}from"./index.ba40ce30.js";import{u as o}from"./index.3107f185.js";import"./index.bdfa8201.js";import"./_commonjsHelpers.b8add541.js";import"./iframe.fee97a54.js";import"../sb-preview/runtime.js";import"./index.5ca63ce8.js";import"./index.5f460d07.js";import"./index.d612502e.js";import"./index.b38f6aa4.js";function t(r){const s=Object.assign({h1:"h1",p:"p",ul:"ul",li:"li",code:"code",strong:"strong",h2:"h2",h3:"h3",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td",a:"a",h4:"h4",pre:"pre"},o(),r.components);return e.exports.jsxs(e.exports.Fragment,{children:[e.exports.jsx(n,{title:"Docs/Development/Custom UI5 Web Components Packages"}),`
`,e.exports.jsx(s.h1,{id:"creating-a-custom-ui5-web-components-package",children:"Creating a Custom UI5 Web Components Package"}),`
...
`,e.exports.jsx(s.h2,{id:"step-1-create-an-npm-package",children:"Step 1. Create an NPM package."}),`
`,e.exports.jsx(s.h3,{id:"run-the-init-command",children:"Run the init command."}),`
...
`,e.exports.jsx(s.h3,{id:"follow-the-prompts",children:"Follow the prompts."}),`
...
`]}),`
`,e.exports.jsx(s.h3,{id:"your-package-is-ready",children:"Your package is ready!"}),`
...
`]}),`
`,e.exports.jsx(s.h2,{id:"step-2-run-the-dev-server-and-test-the-build",children:"Step 2. Run the dev server and test the build."}),`
...
`,e.exports.jsx(s.h2,{id:"understanding-the-project-structure",children:"Understanding the Project Structure"}),`
`,e.exports.jsx(s.h3,{id:"packagejson",children:e.exports.jsx(s.code,{children:"package.json"})}),`
...
`,e.exports.jsx(s.h3,{id:"files-in-the-main-directory",children:"Files in the main directory"}),`
`,e.exports.jsx(s.p,{children:"The initialization script will create several files in your package's main directory."}),`
`,e.exports.jsxs(s.table,{children:[e.exports.jsx(s.thead,{children:e.exports.jsxs(s.tr,{children:[e.exports.jsx(s.th,{children:"File"}),e.exports.jsx(s.th,{children:"Purpose"})]})}),e.exports.jsxs(s.tbody,{children:[e.exports.jsxs(s.tr,{children:[e.exports.jsx(s.td,{children:".eslintignore"}),e.exports.jsxs(s.td,{children:["Excludes the ",e.exports.jsx(s.code,{children:"dist/"})," and ",e.exports.jsx(s.code,{children:"test/"})," directories from static code scans."]})]}),e.exports.jsxs(s.tr,{children:[e.exports.jsx(s.td,{children:"package-scripts.js"}),e.exports.jsxs(s.td,{children:["An ",e.exports.jsx(s.a,{href:"https://www.npmjs.com/package/nps",target:"_blank",rel:"nofollow noopener noreferrer",children:"nps"})," package scripts configuration file."]})]}),e.exports.jsxs(s.tr,{children:[e.exports.jsx(s.td,{children:"bundle.js"}),e.exports.jsx(s.td,{children:"Entry point for the bundle used for development and tests."})]})]})]}),`
...
`,e.exports.jsxs(s.h3,{id:"the-config-directory",children:["The ",e.exports.jsx(s.code,{children:"config/"})," directory"]}),`
...
`,e.exports.jsx(s.h4,{id:"custom-configuration",children:"Custom configuration"}),`
...
so that we can use `,e.exports.jsx(s.code,{children:"browser.debug()"})," in our ",e.exports.jsx(s.code,{children:"*.spec.js"})," files. For more on testing, see ",e.exports.jsx(s.a,{href:"./?path=/docs/docs-development-testing-ui5-web-components--docs",children:"Testing Web Components"}),"."]}),`
`]}),`
`]}),`
`,e.exports.jsxs(s.h3,{id:"the-src-directory",children:["The ",e.exports.jsx(s.code,{children:"src/"})," directory"]}),`
...
`,e.exports.jsx(s.h4,{id:"class-and-template-files",children:"Class and template files"}),`
...
`,e.exports.jsx(s.a,{href:"./?path=/docs/docs-development-custom-ui5-web-components--docs",children:"Developing Web Components"})," section of the documentation."]}),`
...
`,e.exports.jsx(s.h4,{id:"theming-related-files",children:"Theming-related files"}),`
...
`,e.exports.jsxs(s.p,{children:["Again, to know more about how these files work, you could have a look at the ",e.exports.jsx(s.a,{href:"#css",children:"Developing Web Components"})," section of the documentation."]}),`
`,e.exports.jsx(s.h4,{id:"i18n-files",children:"i18n files"}),`
...
`})}),`
`,e.exports.jsx(s.h4,{id:"assets-additional-themes-i18n-texts-etc",children:"Assets (additional themes, i18n texts, etc.)"}),`
...
`,e.exports.jsxs(s.h3,{id:"the-test-directory",children:["The ",e.exports.jsx(s.code,{children:"test/"})," directory"]}),`
`,e.exports.jsxs(s.table,{children:[e.exports.jsx(s.thead,{children:e.exports.jsxs(s.tr,{children:[e.exports.jsx(s.th,{children:"File"}),e.exports.jsx(s.th,{children:"Purpose"})]})}),e.exports.jsxs(s.tbody,{children:[e.exports.jsxs(s.tr,{children:[e.exports.jsx(s.td,{children:e.exports.jsx(s.code,{children:"test/pages/*"})}),e.exports.jsxs(s.td,{children:["Simple ",e.exports.jsx(s.code,{children:".html"})," pages used for development and tests."]})]}),e.exports.jsxs(s.tr,{children:[e.exports.jsx(s.td,{children:e.exports.jsx(s.code,{children:"src/specs/*"})}),e.exports.jsxs(s.td,{children:["Test specs, based on ",e.exports.jsx(s.a,{href:"https://www.npmjs.com/package/wdio",target:"_blank",rel:"nofollow noopener noreferrer",children:"WDIO"}),". They use the test pages for setup."]})]})]})]}),`
...
`,e.exports.jsxs(s.p,{children:["For more on testing, see our ",e.exports.jsx(s.a,{href:"./?path=/docs/docs-development-testing-ui5-web-components--docs",children:"Testing Web Components"})," section."]}),`
`,e.exports.jsx(s.h2,{id:"public-consumption-of-your-custom-ui5-web-components-package",children:"Public Consumption of Your Custom UI5 Web Components Package"}),`
...
`})}),`
`,e.exports.jsxs(s.p,{children:["Next: ",e.exports.jsx(s.a,{href:"./?path=/docs/docs-development-custom-ui5-web-components--docs",children:"Developing Custom UI5 Web Components"})]})]})}function f(r={}){const{wrapper:s}=Object.assign({},o(),r.components);return s?e.exports.jsx(s,Object.assign({},r,{children:e.exports.jsx(t,r)})):t(r)}export{f as default};
//# sourceMappingURL=01-custom-UI5-Web-Components-Packages.e1cf82df.js.map
