...
In cases like this, we recommend using `,e.jsx(t.code,{children:"ignoreCustomElements"})," to let the UI5 Web Components framework treats such custom HTML elements as if they are standard HTML elements, such as: ",e.jsx(t.code,{children:"div"}),", ",e.jsx(t.code,{children:"span"}),", etc."]})]})}function g(n={}){const{wrapper:t}=Object.assign({},r(),n.components);return t?e.jsx(t,Object.assign({},n,{children:e.jsx(s,n)})):s(n)}export{g as default};
//# sourceMappingURL=10-ignore-custom-elements-9302def4.js.map
