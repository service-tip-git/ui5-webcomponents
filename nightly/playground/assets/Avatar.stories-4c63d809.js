...
`,h="ui5-avatar",j={title:"Main/Avatar",component:"Avatar",argTypes:b,parameters:{docs:{page:v({...$,component:h})}}},m=e=>p`<ui5-avatar
    icon="${a(e.icon)}"
    size="${a(e.size)}"
    shape="${a(e.shape)}"
    style="${a(e.style)}"
