import{x as a}from"./lit-element-c5a2b594.js";import{o as n}from"./unsafe-html-0ddd83da.js";import{l as b}from"./if-defined-c29cffe1.js";import{D as x}from"./docs-7cc24d98.js";import"./jsx-runtime-670e1be8.js";import"./index-4e9ba9b8.js";import"./_commonjsHelpers-725317a4.js";import"./Footer-ac52f94c.js";import"./index-c5b45678.js";import"./iframe-ac31e5f8.js";import"../sb-preview/runtime.js";import"./index-11d98b33.js";import"./index-d38538b0.js";import"./index-356e4a49.js";import"./chunk-HLWAVYOI-bb8a36b5.js";import"./client-fb0f3103.js";const f={default:{control:{type:"text"},table:{type:{summary:"Array<SideNavigationItem>"}}},header:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},fixedItems:{control:{type:"text"},table:{type:{summary:"Array<SideNavigationItem>"}}},"selection-change":{description:"Fired when the selection has changed via user interaction",control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"SideNavigationItemBase",references:[{name:"SideNavigationItemBase",package:"@ui5/webcomponents-fiori",module:"dist/SideNavigationItemBase.js"}]},name:"item",_ui5privacy:"public",description:"the clicked item."}]}}},h={package:"@ui5/webcomponents-fiori",since:"1.0.0-rc.8"};var o=Object.freeze,y=Object.defineProperty,S=(i,v)=>o(y(i,"raw",{value:o(v||i.slice())})),s;const I="ui5-side-navigation",A={title:"Fiori/Side Navigation",component:"SideNavigation",parameters:{docs:{page:x({...h,component:I})}},argTypes:f},g=i=>a`
...
${i()}`,e=g.bind({});e.args={default:`<ui5-side-navigation-item text="Home" icon="home"></ui5-side-navigation-item>
    ...
    <ui5-side-navigation-item slot="fixedItems" text="History" icon="history"></ui5-side-navigation-item>`};e.decorators=[p];e.parameters={docs:{story:{iframeHeight:"700px",inline:!1}}};const t=g.bind({});t.args={default:`<ui5-side-navigation-item text="Home" icon="home"></ui5-side-navigation-item>
    <ui5-side-navigation-item text="People" expanded icon="group">
        <ui5-side-navigation-sub-item text="From My Team"></ui5-side-navigation-sub-item>
...
<\/script>`])),i())];t.parameters={layout:"fullscreen",docs:{story:{iframeHeight:"700px",inline:!1}}};var r,m,d;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`args => {
  return html\`
...
}`,...(d=(m=e.parameters)==null?void 0:m.docs)==null?void 0:d.source}}};var u,l,c;t.parameters={...t.parameters,docs:{...(u=t.parameters)==null?void 0:u.docs,source:{originalSource:`args => {
  return html\`
<ui5-side-navigation ?collapsed="\${ifDefined(args.collapsed)}">
    \${args.header ? unsafeHTML(args.header) : null}
    \${unsafeHTML(args.default)}
...
}`,...(c=(l=t.parameters)==null?void 0:l.docs)==null?void 0:c.source}}};const j=["Basic","ToolLayout"];export{e as Basic,t as ToolLayout,j as __namedExportsOrder,A as default};
