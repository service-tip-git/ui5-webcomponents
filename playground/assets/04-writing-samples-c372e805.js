import{j as e}from"./jsx-runtime-5fc188ad.js";import{M as s}from"./index-9c2f7062.js";import{u as r}from"./index-cf712c1b.js";import"./index-c0290abd.js";import"./_commonjsHelpers-725317a4.js";import"./iframe-17871902.js";import"../sb-preview/runtime.js";import"./index-d475d2ea.js";import"./index-d37d4223.js";import"./index-d38538b0.js";import"./index-356e4a49.js";function n(t){const o=Object.assign({h1:"h1",p:"p",h2:"h2",a:"a",h3:"h3",pre:"pre",code:"code",ul:"ul",li:"li"},r(),t.components);return e.jsxs(e.Fragment,{children:[e.jsx(s,{title:"Docs/Contributing/Writing samples"}),`
`,e.jsx(o.h1,{id:"ui5-web-components-storybook-app",children:"UI5 Web Components Storybook App"}),`
`,e.jsx(o.p,{children:`The UI5 Web Components Storybook app is a playground for testing and documenting the UI5 Web Components library. It allows developers to create stories for each UI component,
capturing its rendered state in various scenarios, and to document all the potential states that a component can display.`}),`
`,e.jsx(o.h2,{id:"running-the-ui5-web-components-storybook-app-locally",children:"Running the UI5 Web Components Storybook App Locally"}),`
...
`,e.jsx(o.pre,{children:e.jsx(o.code,{className:"language-bash",children:`yarn build # this step needs to be performed only the first time you run the project, to build the project initially
`})}),`
`,e.jsx(o.h3,{id:"2-go-to-the-playground-package",children:"2. Go to the playground package."}),`
`,e.jsx(o.pre,{children:e.jsx(o.code,{className:"language-bash",children:`cd packages/playground
yarn storybook # to run the storybook app
`})}),`
`,e.jsx(o.p,{children:"Note that these steps are required only for running the Storybook app locally and not for general development."}),`
...
`,e.jsxs(o.li,{children:["Make sure you have built the sources by running ",e.jsx(o.code,{children:"yarn build"}),"."]}),`
...
`]})]})}function x(t={}){const{wrapper:o}=Object.assign({},r(),t.components);return o?e.jsx(o,Object.assign({},t,{children:e.jsx(n,t)})):n(t)}export{x as default};
//# sourceMappingURL=04-writing-samples-c372e805.js.map
