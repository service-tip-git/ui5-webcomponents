...
export default `.ui5-tab-semantic-icon{display:var(--_ui5-v2-15-0_tc_headerItemSemanticIcon_display);height:var(--_ui5-v2-15-0_tc_headerItemSemanticIcon_size);width:var(--_ui5-v2-15-0_tc_headerItemSemanticIcon_size);margin-inline-end:.5rem}.ui5-tab-semantic-icon--positive{color:var(--sapPositiveTextColor)}.ui5-tab-semantic-icon--negative{color:var(--sapNegativeTextColor)}.ui5-tab-semantic-icon--critical{color:var(--sapCriticalTextColor)}
`;
