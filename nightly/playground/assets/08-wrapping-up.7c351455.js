...
`,e.exports.jsxs(s.h2,{id:"applying-the-learnings-in-the-vite-app",children:["Applying the Learnings in the ",e.exports.jsx(s.code,{children:"vite"})," App"]}),`
`,e.exports.jsxs(s.p,{children:["If you created the test app, described in ",e.exports.jsx(s.a,{href:"./?path=/docs/docs-getting-started-readme--docs",children:"Getting Started"}),", you can enhance it as follows:"]}),`
...
`,e.exports.jsx(s.p,{children:e.exports.jsx(s.a,{href:"http://localhost:3000/?sap-ui-theme=sap_belize_hcb&sap-ui-language=de",target:"_blank",rel:"nofollow noopener noreferrer",children:"http://localhost:3000/?sap-ui-theme=sap_belize_hcb&sap-ui-language=de"})}),`
`,e.exports.jsx(s.p,{children:"You should be able to see the page with an accessibility theme, and in German language."})]})}function g(t={}){const{wrapper:s}=Object.assign({},n(),t.components);return s?e.exports.jsx(s,Object.assign({},t,{children:e.exports.jsx(o,t)})):o(t)}export{g as default};
//# sourceMappingURL=08-wrapping-up.7c351455.js.map
