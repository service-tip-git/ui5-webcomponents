import{x as i}from"./lit-element-c5a2b594.js";import{l as a}from"./if-defined-c29cffe1.js";import{o as D}from"./unsafe-html-0ddd83da.js";const b={valueState:{control:"select",options:["None","Success","Warning","Error","Information"]},valueStateMessage:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}}},E={package:"@ui5/webcomponents",tagName:"ui5-textarea"};var o=Object.freeze,v=Object.defineProperty,M=(e,h)=>o(v(e,"raw",{value:o(h||e.slice())})),l;let s=0;const S={title:"Main/Text Area",component:"TextArea",argTypes:b},d=e=>i`
<ui5-textarea
    id="textArea-${s++}"
    value="${a(e.value)}"
...
>
    \${unsafeHTML(args.valueStateMessage)}
</ui5-textarea>\``,...(w=(p=r.parameters)==null?void 0:p.docs)==null?void 0:w.source}}};const y=["Basic","MaxLength","Label"],L=Object.freeze(Object.defineProperty({__proto__:null,Basic:t,Label:r,MaxLength:n,__namedExportsOrder:y,default:S},Symbol.toStringTag,{value:"Module"}));export{L as C,E as c};
