import{j as e}from"./jsx-runtime-5fc188ad.js";import{M as i}from"./index-4c998f51.js";import{F as d}from"./Footer-dcd144d6.js";import{u as t}from"./index-cf712c1b.js";import"./index-c0290abd.js";import"./_commonjsHelpers-725317a4.js";import"./iframe-3aaab046.js";import"../sb-preview/runtime.js";import"./index-d475d2ea.js";import"./index-d37d4223.js";import"./index-d38538b0.js";import"./index-356e4a49.js";function r(n){const s=Object.assign({h1:"h1",p:"p",ul:"ul",li:"li",code:"code",strong:"strong",h2:"h2",h3:"h3",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td",a:"a",h4:"h4",pre:"pre"},t(),n.components);return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Docs/Development/Custom UI5 Web Components Packages"}),`
...
`,e.jsxs(s.table,{children:[e.jsx(s.thead,{children:e.jsxs(s.tr,{children:[e.jsx(s.th,{children:"File"}),e.jsx(s.th,{children:"Purpose"})]})}),e.jsxs(s.tbody,{children:[e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"src/themes/MyFirstComponent.css"})}),e.jsx(s.td,{children:"All CSS rules for the Web Component, same for all themes; will be inserted in the shadow root."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"src/themes/sap_belize/parameters-bundle.css"})}),e.jsxs(s.td,{children:["Values for the component-specific CSS Vars for the ",e.jsx(s.code,{children:"sap_belize"})," theme"]})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"src/themes/sap_belize_hcb/parameters-bundle.css"})}),e.jsxs(s.td,{children:["Values for the component-specific CSS Vars for the ",e.jsx(s.code,{children:"sap_belize_hcb"})," theme"]})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"src/themes/sap_belize_hcw/parameters-bundle.css"})}),e.jsxs(s.td,{children:["Values for the component-specific CSS Vars for the ",e.jsx(s.code,{children:"sap_belize_hcw"})," theme"]})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"src/themes/sap_fiori_3/parameters-bundle.css"})}),e.jsxs(s.td,{children:["Values for the component-specific CSS Vars for the ",e.jsx(s.code,{children:"sap_fiori_3"})," theme"]})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"src/themes/sap_fiori_3_dark/parameters-bundle.css"})}),e.jsxs(s.td,{children:["Values for the component-specific CSS Vars for the ",e.jsx(s.code,{children:"sap_fiori_3_dark"})," theme"]})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"src/themes/sap_fiori_3_hcb/parameters-bundle.css"})}),e.jsxs(s.td,{children:["Values for the component-specific CSS Vars for the ",e.jsx(s.code,{children:"sap_fiori_3_hcb"})," theme"]})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"src/themes/sap_fiori_3_hcw/parameters-bundle.css"})}),e.jsxs(s.td,{children:["Values for the component-specific CSS Vars for the ",e.jsx(s.code,{children:"sap_fiori_3_hcw"})," theme"]})]})]})]}),`
...
`})}),`
`,e.jsxs(s.p,{children:["Next: ",e.jsx(s.a,{href:"./?path=/docs/docs-development-custom-ui5-web-components--docs",children:"Developing Custom UI5 Web Components"})]}),`
`,e.jsx(d,{})]})}function y(n={}){const{wrapper:s}=Object.assign({},t(),n.components);return s?e.jsx(s,Object.assign({},n,{children:e.jsx(r,n)})):r(n)}export{y as default};
//# sourceMappingURL=01-custom-UI5-Web-Components-Packages-6b484d31.js.map
