  ...
  return (
    <>
      ...
      <div id="output" style={{ marginTop: "1rem", fontFamily: "var(--sapFontFamily)", color: "var(--sapTextColor)" }}>
        <div>Employee ID: <strong id="employee-id">{employeeId}</strong></div>
        <div>Name: <strong id="employee-name">{employeeName}</strong></div>
        <div>Department: <strong id="employee-dept">{employeeDept}</strong></div>
      </div>
    </>
  );
}
