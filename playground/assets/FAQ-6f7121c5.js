...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"A:"})," Use this ",e.jsx(n.a,{href:"https://codesandbox.io/s/71r1x5o51q?fontsize=14&module=%2Findex.html",target:"_blank",rel:"nofollow noopener noreferrer",children:"CodeSandBox"}),"."]}),`
...
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Q: How can I cancustomize UI5 Web Components' styles?"})}),`
...
`})}),`
`,e.jsxs(n.p,{children:["Please note that the ",e.jsx(n.code,{children:":defined"})," CSS pseudo-selector is not supported by the Edge and Internet Explorer 11 browsers."]})]})}function g(s={}){const{wrapper:n}=Object.assign({},r(),s.components);return n?e.jsx(n,Object.assign({},s,{children:e.jsx(o,s)})):o(s)}export{g as default};
//# sourceMappingURL=FAQ-6f7121c5.js.map
