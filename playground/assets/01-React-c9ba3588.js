...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Important:"})," The get the best development experience, we recommend using the ",e.jsx(n.a,{href:"https://github.com/SAP/ui5-webcomponents-react",target:"_blank",rel:"nofollow noopener noreferrer",children:"UI5 Web Components for React"})," and follow the ",e.jsx(n.a,{href:"https://developers.sap.com/mission.react-spa.html",target:"_blank",rel:"nofollow noopener noreferrer",children:"UI5 Web Components for React Тutorial"}),'. UI5 Web Components for React library is a React implementation of UI5 Web Components which overcomes several limitations of React in handling web components in general, explained in the "Additional Info" section below.']}),`
...
`,e.jsxs(n.p,{children:["As mentioned above, for a better development experience (and to elegantly work around these 2 React limitations), check out UI5 Web Components for React, ",e.jsx(n.a,{href:"https://github.com/SAP/ui5-webcomponents-react",target:"_blank",rel:"nofollow noopener noreferrer",children:"UI5 Web Components for React"})," and ",e.jsx(n.a,{href:"https://developers.sap.com/mission.react-spa.html",target:"_blank",rel:"nofollow noopener noreferrer",children:"this tutorial"}),"."]})]})}function g(t={}){const{wrapper:n}=Object.assign({},s(),t.components);return n?e.jsx(n,Object.assign({},t,{children:e.jsx(o,t)})):o(t)}export{g as default};
//# sourceMappingURL=01-React-c9ba3588.js.map
