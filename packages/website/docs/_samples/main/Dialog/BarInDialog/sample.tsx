  ...
  return (
    <>
      ...
      <Button id="dialogOpener" onClick={() => setDialogOpen(true)}>Open Dialog</Button>
        ...
        <Dialog open={dialogOpen} id="dialog" onClose={() => setDialogOpen(false)}>
            <Bar slot="header" design="Header">
                <Title level="H5" slot="startContent">Bar used in Header and Footer</Title>
                <Button class="dialogCloser" design="Transparent" slot="endContent" icon="decline" onClick={() => setDialogOpen(false)} />
            </Bar>
            ...
            <Bar slot="footer" design="Footer">
                <Button style={{ minWidth: "4rem" }} class="dialogCloser" design="Emphasized" slot="endContent" onClick={() => setDialogOpen(false)}>OK</Button>
            </Bar>
        </Dialog>

         <Button id="dialogStateOpener" onClick={() => setDialogStateOpen(true)}>Open Dialog with State</Button>

        <Dialog open={dialogStateOpen} id="dialogState" state="Critical" onClose={() => setDialogStateOpen(false)}>
            ...
            <Bar slot="footer" design="Footer">
                <Button style={{ minWidth: "4rem" }} design="Emphasized" id="closeDialogStateButton" slot="endContent" onClick={() => setDialogStateOpen(false)}>OK</Button>
            </Bar>
        </Dialog>
    </>
  );
