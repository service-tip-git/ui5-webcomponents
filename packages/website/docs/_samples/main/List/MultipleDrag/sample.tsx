...
function App() {
  ...
  const handleMove = (e: UI5CustomEvent<ListClass, "move">) => {
    ...
    const itemsToMove = sourceSelected.has(sourceId) && sourceSelected.size > 1
  ...
  return (
    <>
      <div className="demo-container" style={{ display: "flex", gap: "2rem", padding: "1rem" }}>
            <div className="demo-section" style={{ flex: 1, maxWidth: "300px" }}>
                <div className="info" style={{ fontSize: "0.875rem", color: "var(--sapNeutralTextColor)", marginBottom: "1rem", padding: "0.5rem", background: "var(--sapTile_Background)", borderRadius: "0.25rem" }}>
                    Selected: <span style={{ fontWeight: "bold", color: "var(--sapHighlightColor)" }}>{selected1.size}</span> items<br />
            ...
            <div className="demo-section" style={{ flex: 1, maxWidth: "300px" }}>
                <div className="info" style={{ fontSize: "0.875rem", color: "var(--sapNeutralTextColor)", marginBottom: "1rem", padding: "0.5rem", background: "var(--sapTile_Background)", borderRadius: "0.25rem" }}>
                    Selected: <span style={{ fontWeight: "bold", color: "var(--sapHighlightColor)" }}>{selected2.size}</span> items<br />
