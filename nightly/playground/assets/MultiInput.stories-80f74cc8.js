import{x as b}from"./lit-element-c5a2b594.js";import{D as w}from"./docs-84040a3f.js";import{l as t}from"./if-defined-c29cffe1.js";import{o}from"./unsafe-html-0ddd83da.js";import"./jsx-runtime-670e1be8.js";import"./index-4e9ba9b8.js";import"./_commonjsHelpers-725317a4.js";import"./Footer-4f103317.js";import"./index-1ddc0cbe.js";import"./iframe-b6eaac03.js";import"../sb-preview/runtime.js";import"./index-11d98b33.js";import"./index-d38538b0.js";import"./index-356e4a49.js";import"./chunk-HLWAVYOI-40facfd7.js";import"./client-fb0f3103.js";const S={valueState:{control:"select",options:["None","Success","Warning","Error","Information"]},previewItem:{control:{type:!1}},tokens:{control:{type:"text"},table:{type:{}}},default:{control:{type:"text"},table:{type:{}}},icon:{control:{type:"text"},table:{type:{}}},valueStateMessage:{control:{type:"text"},table:{type:{}}},openPicker:{description:"Manually opens the suggestions popover, assuming suggestions are enabled. Items must be preloaded for it to open.",table:{category:"methods"},UI5CustomData:{returnValue:{type:{text:"void"}}}}},M={package:"@ui5/webcomponents"};var l=Object.freeze,L=Object.defineProperty,I=(e,T)=>l(L(e,"raw",{value:l(T||e.slice())})),d;const E="ui5-multi-input",G={title:"Main/Multi Input",component:"MultiInput",parameters:{docs:{page:w({...M,component:E})}},argTypes:S};let r=0;const u=e=>b`
<ui5-multi-input
    id="multi-input-${++r}"
...
>
    ...
    <ui5-suggestion-item text="USA"></ui5-suggestion-item>`,valueStateMessage:'<div slot="valueStateMessage">Token is already in the list</div>'};n.decorators=[e=>b(d||(d=I([`
	`,`
<script>
...
>
    ...
    \${unsafeHTML(args.icon)}
    \${unsafeHTML(args.tokens)}
</ui5-multi-input>\``,...(v=(f=a.parameters)==null?void 0:f.docs)==null?void 0:v.source}}};var $,h,k;n.parameters={...n.parameters,docs:{...($=n.parameters)==null?void 0:$.docs,source:{originalSource:`args => html\`
<ui5-multi-input
    id="multi-input-\${++index}"
    ?disabled="\${ifDefined(args.disabled)}"
    placeholder="\${ifDefined(args.placeholder)}"
...
>
    ...
    \${unsafeHTML(args.icon)}
    \${unsafeHTML(args.tokens)}
</ui5-multi-input>\``,...(k=(h=n.parameters)==null?void 0:h.docs)==null?void 0:k.source}}};var x,D,y;s.parameters={...s.parameters,docs:{...(x=s.parameters)==null?void 0:x.docs,source:{originalSource:`args => html\`
<ui5-multi-input
    id="multi-input-\${++index}"
    ?disabled="\${ifDefined(args.disabled)}"
    placeholder="\${ifDefined(args.placeholder)}"
...
>
    ...
    \${unsafeHTML(args.icon)}
    \${unsafeHTML(args.tokens)}
</ui5-multi-input>\``,...(y=(D=s.parameters)==null?void 0:D.docs)==null?void 0:y.source}}};const J=["Basic","Tokens","TokenCreation","SuggestionsWrapping"];export{i as Basic,s as SuggestionsWrapping,n as TokenCreation,a as Tokens,J as __namedExportsOrder,G as default};
