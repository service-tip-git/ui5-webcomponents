const E = "कार्ड सामग्री", _ = "कार्ड", T = "कार्ड शीर्षलेख", A = "सहभागी कार्ड हेडर", I = "अवतार", R = "{0} प्रदर्शित, {1} छिपा हुआ.", O = "पूरी सूची के लिए सक्रिय करें.", L = "व्यक्तिगत अवतार.", N = "जुड़े हुए अवतार.", S = "ले जाने के लिए तीर कुंजियां दबाएं.", C = "बैज", D = "{1} में से {0}", P = "ब्रेडक्रम सत्यापन", B = "अधिक", U = "रद्द करें", t = "कृपया प्रतीक्षा करें", s = "सकारात्मक कार्रवाई", n = "नकारात्मक कार्रवाई", o = "बल दिया गया", c = "इसका", M = "आइटम {0} / {1} प्रदर्शित किए गए", G = "पिछला पृष्ठ", K = "अगला पृष्ठ", V = "रंग पैलेट - पहले से परिभाषित रंग", H = "रंग पैलेट", X = "रंग", Y = "रद्द करें", W = "ठीक", F = "रंग परिवर्तित करें", Z = "अधिक रंग...", e = "अल्फ़ा नियंत्रण", a = "छटा नियंत्रण", d = "हेक्साडेसिमल", i = "लाल", l = "हरा", p = "नीला", u = "अल्फ़ा", J = "चुननेवाला खोलें", b = "दिनांक इनपुट", f = "दिनांक समय इनपुट", g = "दिनांक श्रेणी इनपुट", h = "हटाएं", m = "ब्राउज़ करें ...", r = "फ़ाइल अपलोड करें", x = "समूह शीर्षलेख", j = "सूचीबॉक्स", k = "विकल्पों का चयन करें", q = "सुझाव उपलब्ध हैं", v = "चुनें", w = "1 परिणाम उपलब्ध है", y = "{0} परिणाम उपलब्ध है", z = "कोई परिणाम नहीं", Q = "सूक्ष्म", $ = "बल दिया गया", EE = "सूची आइटम {0} / {1}", _E = "चयनित किया गया", TE = "चयनित नहीं किया गया", AE = "समूह शीर्षलेख", IE = "एकाधिक चयन मोड", RE = "आइटम चयन.", OE = "चयन करनेयोग्य आइटम", LE = "एकल-चयनयोग्य आइटम शामिल होता है", NE = "हटानेयोग्य आइटम शामिल होता है", SE = "जानकारी बार बंद करें", CE = "बंद करने योग्य", DE = "जानकारी बार में त्रुटि", PE = "जानकारी बार की चेतावनी", BE = "सफल जानकारी बार", UE = "जानकारी बार", tE = "ठीक", sE = "यह मान पहले से ही चयनित है.", nE = "एकाधिक मान इनपुट", oE = "{0} अधिक", cE = "विस्तृत/संकुचित", ME = "श्रेणी", GE = "बायां हैंडल", KE = "दायां हैंडल", VE = "रेटिंग", HE = "रेटिंग संकेतक", XE = "आवश्यक", YE = "अस्वीकृत करें", WE = "सेगमेंट किए गए बटन समूह", FE = "किसी आइटम का चयन करने के लिए SPACE या ENTER दबाएं", ZE = "सेगमेंट किए गए बटन", eE = "स्लाइडर हैंडल", aE = "अधिक", dE = "शीर्षलेख पंक्ति 1 का {0}", iE = "{1} में से {0}", lE = "समूह हेडर पंक्ति", pE = "आइटम चयन", uE = "सभी पंक्तियों का चयन करें", JE = "रिक्त", bE = "सकारात्मक", fE = "ऋणात्मक", gE = "समीक्षात्मक", hE = "न्यूट्रल", mE = "सबआइटम सहित टैब", rE = "अगला", xE = "पिछला", jE = "ओवरफ़्लो मेनू", kE = "अधिक", qE = "रद्द करें", vE = "सबआइटम मेनु खोलने के लिए नीचे तीर कुंजी दबाएं", wE = "{0} शेष वर्ण", yE = "{0} सीमा से अधिक वर्ण", zE = "घंटे", QE = "मिनट", $E = "सेकंड", E_ = "ठीक", __ = "रद्द करें", T_ = "समय इनपुट", A_ = "क्लॉक डायल", I_ = "अवधि इनपुट", R_ = "दिनांक", O_ = "समय", L_ = "हटाने योग्य है", N_ = "कोई टोकन नहीं", S_ = "1 टोकन शामिल करता है", C_ = "{0} टोकन शामिल हैं", D_ = "टोकनाईज़र", P_ = "निकालें", B_ = "{0} आइटम", U_ = "ट्री आइटम", t_ = "नोड विस्तृत करें", s_ = "नोड संकुचित करें", n_ = "मान कथन त्रुटि", o_ = "मान कथन चेतावनी", c_ = "मान स्थिति सफल रहा", M_ = "मान स्थिति जानकारी", G_ = "अमान्य प्रविष्टि", K_ = "चेतावनी जारी", V_ = "सूचनात्मक प्रविष्टि", H_ = "प्रविष्टि सफलतापूर्वक मान्य हुई", X_ = "अगला", Y_ = "पिछला", W_ = "सप्ताह संख्या", F_ = "गैर-कार्य दिन", Z_ = "आज", e_ = "महीना पिकर", a_ = "वर्ष पिकर", d_ = "कमी", i_ = "वृध्दि", l_ = "विभाजन बटन", p_ = "डिफ़ॉल्ट क्रिया ट्रिगर करने के लिए स्पेस या दर्ज करें दबाएं और तीर क्रिया ट्रिगर करने के लिए Alt + नीचे तीर या F4 दबाएं", u_ = "वापस जाएं", J_ = "अस्वीकृत करें", b_ = "सहभागिता शीर्षलेख", f_ = "आकार के लिए शिफ्ट+तीर कुंजियों का उपयोग करें", g_ = "ले जाने के लिए तीर कुंजियों का उपयोग करें", h_ = "ले जाने के लिए तीर कुंजियों का उपयोग करें, आकार के लिए शिफ्ट+तीर कुंजियां", m_ = ":", r_ = "Additional Options", x_ = {
  ...
  TABCONTAINER_NEXT_ICON_ACC_NAME: rE,
  ...
  LABEL_COLON: m_,
  TOOLBAR_OVERFLOW_BUTTON_ARIA_LABEL: r_
};
export {
  ...
  i_ as STEPINPUT_INC_ICON_TITLE,
  kE as TABCONTAINER_END_OVERFLOW,
  rE as TABCONTAINER_NEXT_ICON_ACC_NAME,
  ...
  r_ as TOOLBAR_OVERFLOW_BUTTON_ARIA_LABEL,
