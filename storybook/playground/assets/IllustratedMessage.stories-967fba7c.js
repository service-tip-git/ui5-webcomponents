import{x as $}from"./lit-element-c5a2b594.js";import{l as n}from"./if-defined-c29cffe1.js";import{o as a}from"./unsafe-html-0ddd83da.js";import{I as D}from"./IllustrationMessageType-f0f4890b.js";const x={design:{control:"select",options:["Auto","Base","Dot","Spot","Dialog","Scene"]},titleLevel:{control:"select",options:["H1","H2","H3","H4","H5","H6"]},title:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement> & string"}}},subtitle:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},default:{control:{type:"text"},table:{type:{summary:"Array<IButton>"}}}},M={package:"@ui5/webcomponents-fiori",since:"1.0.0-rc.15",tagName:"ui5-illustrated-message"};var l=Object.freeze,v=Object.defineProperty,L=(e,T)=>l(v(e,"raw",{value:l(T||e.slice())})),s;const h={title:"Fiori/Illustrated Message",component:"IllustratedMessage",argTypes:x},y=e=>$` <ui5-illustrated-message
    name="${n(e.name)}"
    design="${n(e.design)}"
...
`]))),t=y.bind({});t.args={name:D.UnableToUpload,title:`
    ...
    <\/script>
\``,...(m=(g=o.parameters)==null?void 0:g.docs)==null?void 0:m.source}}};var f,p,b;t.parameters={...t.parameters,docs:{...(f=t.parameters)==null?void 0:f.docs,source:{originalSource:'args => html` <ui5-illustrated-message\n    name="${ifDefined(args.name)}"\n    design="${ifDefined(args.design)}"\n    subtitle-text="${ifDefined(args.subtitleText)}"\n    title-text="${ifDefined(args.titleText)}"\n    accessible-name-ref="${ifDefined(args.accessibleNameRef)}"\n    title-level="${ifDefined(args.titleLevel)}"\n>\n    ${unsafeHTML(args.title)}\n    ${unsafeHTML(args.subtitle)}\n    ${unsafeHTML(args.default)}\n</ui5-illustrated-message>`',...(b=(p=t.parameters)==null?void 0:p.docs)==null?void 0:b.source}}};const B=["Basic","WithADialog","CustomTitle"],C=Object.freeze(Object.defineProperty({__proto__:null,Basic:i,CustomTitle:t,WithADialog:o,__namedExportsOrder:B,default:h},Symbol.toStringTag,{value:"Module"}));export{C,M as c};
