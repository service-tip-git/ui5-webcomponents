...
`,e.exports.jsxs(s.p,{children:[e.exports.jsx(s.em,{children:"Note:"})," This section is dedicated to apps. For information on how to set up ",e.exports.jsx(s.code,{children:"i18n"})," for your custom components, please see ",e.exports.jsx(s.a,{href:"./?path=/docs/docs-development-custom-ui5-web-components--docs",children:"Developing Web Components"}),"."]}),`
`,e.exports.jsx(s.h2,{id:"step-by-step-tutorial",children:"Step-by-Step Tutorial"}),`
...
`,e.exports.jsxs(s.h3,{id:"1-start-by-creating-some-i18n-resources-in-properties-format-in-a-directory-that-can-be-served-for-example",children:["1. Start by creating some ",e.exports.jsx(s.code,{children:"i18n"})," resources in ",e.exports.jsx(s.code,{children:".properties"})," format in a directory that can be served, for example:"]}),`
...
`,e.exports.jsxs(s.h3,{id:"2-import-the-following-i18n-related-modules-to-your-app",children:["2. Import the following ",e.exports.jsx(s.code,{children:"i18n"}),"-related modules to your app:"]}),`
...
`,e.exports.jsx(s.h3,{id:"3-register-a-loader-function-that-can-retrieve-and-process-the-actual-content-of-your-message-bundles",children:"3. Register a loader function that can retrieve and process the actual content of your message bundles:"}),`
...
`,e.exports.jsx(s.h3,{id:"4-get-and-use-the-bundle",children:"4. Get and use the bundle:"}),`
...
`,e.exports.jsxs(s.h3,{id:"5-test-your-page-using-different-languages-eg-set-sap-ui-languagede-in-the-url-or-change-the-configuration",children:["5. Test your page using different languages, e.g. set ",e.exports.jsx(s.code,{children:"?sap-ui-language=de"})," in the URL or change the configuration."]}),`
`,e.exports.jsx(s.h2,{id:"summary",children:"Summary"}),`
...
`,e.exports.jsx(s.h2,{id:"tips-and-tricks",children:"Tips and Tricks"}),`
...
`,e.exports.jsxs(s.p,{children:["Next: ",e.exports.jsx(s.a,{href:"./?path=/docs/docs-advanced-accessibility--docs",children:"Accessibility"})]})]})}function g(t={}){const{wrapper:s}=Object.assign({},o(),t.components);return s?e.exports.jsx(s,Object.assign({},t,{children:e.exports.jsx(r,t)})):r(t)}export{g as default};
//# sourceMappingURL=06-using-i18n-for-apps.760a1ada.js.map
