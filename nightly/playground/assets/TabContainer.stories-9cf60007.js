import{x as v}from"./lit-element-c5a2b594.js";import{l as t}from"./if-defined-c29cffe1.js";import{o as k}from"./unsafe-html-0ddd83da.js";import{T as w}from"./TabLayout-8f6a62b3.js";const B={tabLayout:{control:"select",options:["Inline","Standard"]},tabsOverflowMode:{control:"select",options:["End","StartAndEnd"]},headerBackgroundDesign:{control:"select",options:["Solid","Transparent","Translucent"]},contentBackgroundDesign:{control:"select",options:["Solid","Transparent","Translucent"]},allItems:{control:{type:!1}},default:{control:{type:"text"},table:{type:{summary:"Array<ITab>"}}},overflowButton:{control:{type:"text"},table:{type:{summary:"Array<IButton>"}}},startOverflowButton:{control:{type:"text"},table:{type:{summary:"Array<IButton>"}}},"tab-select":{description:"Fired when a tab is selected.",control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"ITab",references:[{name:"ITab",package:"@ui5/webcomponents",module:"dist/Interfaces.js"}]},name:"tab",_ui5privacy:"public",description:"The selected <code>tab</code>."},{type:{text:"Integer",references:[{name:"Integer",package:"@ui5/webcomponents-base",module:"dist/types/Integer.js"}]},name:"tabIndex",_ui5privacy:"public",description:"The selected <code>tab</code> index in the flattened array of all tabs and their subTabs, provided by the <code>allItems</code> getter."}]}}},q={package:"@ui5/webcomponents",tagName:"ui5-tabcontainer"},O={title:"Main/Tab Container",component:"TabContainer",argTypes:B},r=e=>v`<ui5-tabcontainer
    ?fixed="${t(e.fixed)}"
