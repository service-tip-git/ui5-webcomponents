import{x as c}from"./lit-element-c5a2b594.js";import{o as m}from"./unsafe-html-0ddd83da.js";import{l as t}from"./if-defined-c29cffe1.js";const u={default:{control:{type:"text"},table:{type:{summary:"Array<MenuItem>"}}}},x={package:"@ui5/webcomponents",since:"1.3.0",tagName:"ui5-menu-item",showDefaultStoryOnly:!0};var i=Object.freeze,l=Object.defineProperty,f=(e,d)=>i(l(e,"raw",{value:i(d||e.slice())})),a;const p={title:"Main/Menu/MenuItem",component:"MenuItem",argTypes:u},b=e=>c`<ui5-menu id="menuBasic">
    <ui5-menu-item
  ...
  <ui5-menu-item text="Open from Cloud"></ui5-menu-item>`};n.decorators=[e=>c(a||(a=f([`<ui5-button id="btnOpenBasic" class="samples-margin" icon="slim-arrow-down" icon-end>Open Menu</ui5-button> <br/>
	`,`
	<script>
