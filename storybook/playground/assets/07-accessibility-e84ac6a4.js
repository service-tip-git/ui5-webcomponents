import{j as e}from"./jsx-runtime-670e1be8.js";import{M as o}from"./index-d659c909.js";import{F as r}from"./Footer-d1948dbe.js";import{u as s}from"./index-bd2d4f36.js";import"./index-4e9ba9b8.js";import"./_commonjsHelpers-725317a4.js";import"./iframe-4db16312.js";import"../sb-preview/runtime.js";import"./index-11d98b33.js";import"./index-d38538b0.js";import"./index-356e4a49.js";function i(t){const n=Object.assign({h1:"h1",p:"p",h2:"h2",a:"a",code:"code",h3:"h3",strong:"strong",pre:"pre",ul:"ul",li:"li",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td",hr:"hr",em:"em"},s(),t.components);return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Docs/Advanced/Accessibility"}),`
...
`})}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"accessibleName"}),` property is currently supported in most of the available components.
Additionally `,e.jsx(n.code,{children:"headerAccessibleName"})," is available for ",e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/ListItemGroup/",target:"_blank",rel:"nofollow noopener noreferrer",children:"ListItemGroup"})," component, which gives the possibility to add accessible name to the groups headers in a list."]}),`
`,e.jsx(n.hr,{}),`
...
`})}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"accessibleNameRef"})," property is currently supported in most of the available components."]}),`
`,e.jsx(n.hr,{}),`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/ResponsivePopover/",target:"_blank",rel:"nofollow noopener noreferrer",children:"ResponsivePopover"})}),`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/ToggleButton/",target:"_blank",rel:"nofollow noopener noreferrer",children:"ToggleButton"})}),`
`]}),`
`,e.jsx(n.hr,{}),`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/AvatarGroup/",target:"_blank",rel:"nofollow noopener noreferrer",children:"AvatarGroup"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Button/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Button"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Link/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Link"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/ToggleButton/",target:"_blank",rel:"nofollow noopener noreferrer",children:"ToggleButton"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Link/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Link"})}),`
`,e.jsxs(n.li,{children:["List Items (for example ",e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/StandardListItem/",target:"_blank",rel:"nofollow noopener noreferrer",children:"StandardListItem"}),")"]}),`
`]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"accessibilityAttributes"})," is also supported for composite components, where the application can enrich the accessibility of elements inside the component. For a more detailed information check the documentation of the property in:"]}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsx(n.p,{children:"Setting the property on the custom element as:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<ui5-avatar interactive></ui5-avatar>
`})}),`
`,e.jsx(n.p,{children:"Will result in the shadow DOM as:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<div tabindex="0" role="button" ... ></div>
`})}),`
...
`,e.jsx(n.p,{children:"Setting the property on the custom element as:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<ui5-button icon="sap-icon://edit" tooltip="Edit"></ui5-button>
`})}),`
`,e.jsx(n.p,{children:"Will result in the shadow DOM as:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<button title="Edit" ... ></button>
`})}),`
`,e.jsx(n.p,{children:e.jsxs(n.em,{children:["Note: Do not set ",e.jsx(n.code,{children:"title"})," attribute directly on custom element as this could result in repetitive speech output or incorrect accessibility tree mapping."]})}),`
`,e.jsx(n.hr,{}),`
`,e.jsx(n.h3,{id:"icon-modes",children:"Icon Modes"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"ui5-icon"})," component has a ",e.jsx(n.code,{children:"mode"})," property, which provides additional accessibility depending on the mode."]}),`
`,e.jsx(n.p,{children:'Setting the property to "Decorative":'}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<ui5-icon mode="Decorative"></ui5-icon>
`})}),`
`,e.jsx(n.p,{children:"Will result in the shadow DOM as:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<svg role="presentation" aria-hidden="true" ... ></svg>
`})}),`
`,e.jsx(n.p,{children:'Setting the property to "Interactive":'}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<ui5-icon mode="Interactive"></ui5-icon>
`})}),`
`,e.jsx(n.p,{children:"Will result in the shadow DOM as:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<svg tabindex="0" role="button" ... ></svg>
`})}),`
`,e.jsx(n.p,{children:'Setting the property to "Image":'}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<ui5-icon mode="Image"></ui5-icon>
`})}),`
`,e.jsx(n.p,{children:"Will result in the shadow DOM as:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<svg role="img" ... ></svg>
`})}),`
`,e.jsx(n.hr,{}),`
...
`,e.jsx(n.p,{children:"For Screen Reader Support, we recommend using JAWS 2024 + Chrome (latest), and for HTML/ARIA validation the recommended testing tool is Access Assistant. UI5 Web Components support other environments to the extent of providing a valid HTML and ARIA implementation following the WCAG standards."}),`
...
`,e.jsx(n.li,{children:"Reference to the suspected violated accessibility requirement (e.g. Web Content Accessibility Guidelines WCAG 2.2, BITV 2.0, EN 301 549)"}),`
...
`,e.jsx(r,{})]})}function g(t={}){const{wrapper:n}=Object.assign({},s(),t.components);return n?e.jsx(n,Object.assign({},t,{children:e.jsx(i,t)})):i(t)}export{g as default};
