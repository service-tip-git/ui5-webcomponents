...
>
    ...
    <ui5-list selection-mode="SingleStart">
        ...
        <ui5-li key="country4">Germany</ui5-li>
    </ui5-list>`};const t=o.bind({});t.decorators=[e=>s`
            <style>
                #panel-${q+1} {
                    width: 90%;
            ...
            <div style="height: 250px; overflow: scroll;">
                ${e()}
            </div>`];t.args={headerText:"Sticky header",stickyHeader:!0,default:`
    ...
    <p class="content-color">
        ...
        dissentias, no vidit saperet indoctum nec, et pro magna prima nobis. Vis consul feugiat qualisque in, regione
        persecuti cotidieque id eos, id ius omnesque vituperata.
    </p>`};const r=o.bind({});r.decorators=[e=>s`
<style>
    .header {
        display: flex;
        align-items: center;
    ...
    ${e()}`];r.args={accessibleRole:x.Complementary,header:`
...
>
    \${unsafeHTML(args.header)}
    \${unsafeHTML(args.default)}
</ui5-panel>\``,...(f=(p=n.parameters)==null?void 0:p.docs)==null?void 0:f.source}}};var g,b,h;t.parameters={...t.parameters,docs:{...(g=t.parameters)==null?void 0:g.docs,source:{originalSource:`args => html\`
<ui5-panel
    id="panel-\${++index}"
    accessible-role="\${ifDefined(args.accessibleRole)}"
    header-text="\${ifDefined(args.headerText)}"
...
>
    \${unsafeHTML(args.header)}
    \${unsafeHTML(args.default)}
</ui5-panel>\``,...(h=(b=t.parameters)==null?void 0:b.docs)==null?void 0:h.source}}};var v,$,y;r.parameters={...r.parameters,docs:{...(v=r.parameters)==null?void 0:v.docs,source:{originalSource:`args => html\`
<ui5-panel
    id="panel-\${++index}"
    accessible-role="\${ifDefined(args.accessibleRole)}"
    header-text="\${ifDefined(args.headerText)}"
...
>
    \${unsafeHTML(args.header)}
    \${unsafeHTML(args.default)}
</ui5-panel>\``,...(y=($=r.parameters)==null?void 0:$.docs)==null?void 0:y.source}}};const k=["Basic","Fixed","StickyHeader","CustomHeader"],N=Object.freeze(Object.defineProperty({__proto__:null,Basic:a,CustomHeader:r,Fixed:n,StickyHeader:t,__namedExportsOrder:k,default:H},Symbol.toStringTag,{value:"Module"}));export{N as C,C as c};
